<?php
echo "=== Part 2A: Views + Controllers ===\n\n";
 $b = __DIR__;
...
file_put_contents($b.'/app/Http/Controllers/ParentModel/ParentModelController.php', $pc);
echo "[OK] Parent controller\n";

// PARENT INDEX
 $pv = '@extends("layouts.admin")
...
@endsection';
file_put_contents($b.'/resources/views/admin/ParentModel/index.blade.php', $pv);

// PARENT CREATE
 $pcreate = '@extends("layouts.admin")
...
@endsection';
file_put_contents($b.'/resources/views/admin/ParentModel/create.blade.php', $pcreate);

// PARENT EDIT
 $pedit = '@extends("layouts.admin")
...
@endsection';
file_put_contents($b.'/resources/views/admin/ParentModel/edit.blade.php', $pedit);
echo "[OK] Parent views\n";
echo "[OK] Parent module done\n";

// Clear
foreach(['route:clear','config:clear','view:clear','cache:clear'] as $cmd){
    $o=shell_exec('php artisan '.$cmd.' 2>&1'); echo trim($o)."\n";
}
echo "\n=== Part 2A step 1 done. Run fix_part2b.php next. ===\n";
