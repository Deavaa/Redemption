...
<div style="max-width:1200px;margin:0 auto;">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1.25rem;flex-wrap:wrap;gap:1rem;">
        <div>
            ...
            <p style="font-size:13px;color:var(--text-muted);margin:2px 0 0;">Communicate with your teachers and school staff</p>
        </div>
    ...
    <div style="display:grid;grid-template-columns:340px 1fr;gap:0;background:#fff;border-radius:var(--radius);overflow:hidden;box-shadow:var(--shadow);border:1px solid var(--border);height:calc(100vh - 220px);min-height:450px;">
        <div style="border-right:1px solid var(--border);display:flex;flex-direction:column;overflow:hidden;">
            ...
            <div class="chat-list" style="overflow-y:auto;flex:1;">
                @forelse($conversations as $conv)
                    <a href="{{ route('student.chat.show', $conv->id) }}" style="display:flex;align-items:center;gap:0.75rem;padding:0.75rem 1rem;text-decoration:none;color:var(--text);border-bottom:1px solid #f3f4f6;transition:background 0.15s;{{ request()->route('id') == $conv->id ? 'background:var(--primary-light);border-left:3px solid var(--primary);' : '' }}">
