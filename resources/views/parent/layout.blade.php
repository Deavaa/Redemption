...
<div class="parent-wrapper">
    ...
    <div class="parent-main">
        ...
        <div id="parentAnnouncementBar" class="announcement-banner" style="background:linear-gradient(135deg,#ea580c 0%,#c2410c 100%);">
            <div class="announcement-banner-inner">
                <div class="announcement-banner-header">
                    <span class="announcement-badge"><i class="fas fa-bullhorn"></i> ANNOUNCEMENTS</span>
                    <button onclick="document.getElementById('parentAnnouncementBar').style.display='none'" class="announcement-close"><i class="fas fa-times"></i></button>
                </div>
