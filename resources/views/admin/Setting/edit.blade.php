...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Edit Setting</h1>
            <p class="modern-page-subtitle">Update configuration for <strong>{{ $data->key }}</strong></p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.settings.update', $data->id) }}">
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        <h3 class="modern-form-section-title">Setting Details</h3>
                        <p class="modern-form-section-desc">Update the configuration key and its value</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="key">
                                Key <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text"
                                    name="key"
                                    id="key"
                                    class="modern-input {{ $errors->has('key') ? 'is-invalid' : '' }}"
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="value">
                                Value <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text"
                                    name="value"
                                    id="value"
                                    class="modern-input {{ $errors->has('value') ? 'is-invalid' : '' }}"
                                    value="{{ old('value', $data->value) }}"
                                    placeholder="e.g. Redemption Academy"
                                    required>
                            </div>
                            @error('value')
                                <span class="modern-form-error">{{ $message }}</span>
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="group">
                                Group <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text"
                                    name="group"
                                    id="group"
                                    class="modern-input {{ $errors->has('group') ? 'is-invalid' : '' }}"
                                    value="{{ old('group', $data->group) }}"
                                    placeholder="e.g. general, academic, contact"
                                    required>
                            </div>
                            @error('group')
                                <span class="modern-form-error">{{ $message }}</span>
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text"
                                    name="description"
                                    id="description"
                                    class="modern-input {{ $errors->has('description') ? 'is-invalid' : '' }}"
            ...
            <div class="modern-form-actions">
                <a href="{{ route('admin.settings.index') }}" class="btn-modern btn-modern-ghost">
                    Cancel
                </a>
