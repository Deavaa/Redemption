...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Add New Setting</h1>
            <p class="modern-page-subtitle">Create a new system configuration entry</p>
        </div>
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Enter the configuration key and its value</p>
                    </div>
                </div>
