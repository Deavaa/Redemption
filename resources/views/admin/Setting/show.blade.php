...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            <nav aria-label="breadcrumb" class="modern-breadcrumb">
                <ol>
                    ...
                    <li class="active">{{ $data->key }}</li>
                </ol>
            </nav>
            <h1 class="modern-page-title">{{ $data->key }}</h1>
            <p class="modern-page-subtitle">Setting details and configuration</p>
        </div>
        <div class="modern-page-header-right">
            ...
            <a href="{{ route('admin.settings.edit', $data->id) }}" class="btn-modern btn-modern-primary">
        ...
        <div class="modern-card modern-detail-main">
            <div class="modern-detail-hero">
                ...
                <div class="modern-detail-hero-info">
                    <h2 class="modern-detail-hero-title">{{ $data->key }}</h2>
                    <div class="modern-detail-hero-badges">
                        <span class="modern-badge modern-badge-info">{{ ucfirst($data->group) }}</span>
                        @if($data->value)
                            <span class="modern-badge modern-badge-success"><i class="fas fa-check-circle"></i> Configured</span>
                        @else
                            <span class="modern-badge modern-badge-warning"><i class="fas fa-exclamation-circle"></i> Empty</span>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="modern-detail-body">
                <div class="modern-detail-row">
                    ...
                    <div class="modern-detail-value">{{ $data->key }}</div>
                </div>
                <div class="modern-detail-row">
                    <div class="modern-detail-label">
                        <i class="fas fa-font"></i> Value
                    </div>
                    <div class="modern-detail-value">{{ $data->value ?? '-' }}</div>
                </div>
                <div class="modern-detail-row">
                    <div class="modern-detail-label">
                ...
                <div class="modern-detail-row">
                    ...
                    <div class="modern-detail-value">{{ $data->description }}</div>
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="modern-detail-sidebar">
            ...
            <div class="modern-card">
                ...
                <div class="modern-quick-actions">
                    <a href="{{ route('admin.settings.edit', $data->id) }}" class="modern-quick-action">
                        <i class="fas fa-pen"></i>
                        <span>Edit Setting</span>
                    </a>
                    <form method="POST" action="{{ route('admin.settings.destroy', $data->id) }}" onsubmit="return confirm('Are you sure you want to delete this setting? This action cannot be undone.')">
                        @csrf @method('DELETE')
