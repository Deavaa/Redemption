        ...
        <div class="modern-page-header-left">
            <nav aria-label="breadcrumb" class="modern-breadcrumb">
                <ol>
                    ...
                    <li><a href="{{ route('admin.audits.index') }}">Audit Logs</a></li>
                    <li class="active">Add New</li>
                </ol>
            </nav>
            <h1 class="modern-page-title">Add New Audit</h1>
            <p class="modern-page-subtitle">Create a new audit record with findings and recommendations</p>
        </div>
        <div class="modern-page-header-right">
            <a href="{{ route('admin.audits.index') }}" class="btn-modern btn-modern-outline">
        ...
        <form method="POST" action="{{ route('admin.audits.store') }}">
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        <h3 class="modern-form-section-title">Audit Details</h3>
                        <p class="modern-form-section-desc">Enter the auditor name, date, and status</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="auditor_name">
                                Auditor Name <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text"
                                    name="auditor_name"
                                    id="auditor_name"
                                    class="modern-input {{ $errors->has('auditor_name') ? 'is-invalid' : '' }}"
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="audit_date">
                                Audit Date <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                ...
                                <input type="date"
                                    name="audit_date"
                                    id="audit_date"
                                    class="modern-input {{ $errors->has('audit_date') ? 'is-invalid' : '' }}"
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        <h3 class="modern-form-section-title">Findings & Recommendations</h3>
                        <p class="modern-form-section-desc">Document the audit findings and recommended actions</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                        <div class="modern-form-group modern-form-span-2">
                            <label class="modern-form-label" for="findings">
                                Findings <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper modern-input-wrapper-textarea">
                                <i class="fas fa-file-alt modern-input-icon modern-input-icon-top"></i>
                                <textarea name="findings"
                                    id="findings"
                                    class="modern-input modern-textarea {{ $errors->has('findings') ? 'is-invalid' : '' }}"
                        ...
                        <div class="modern-form-group modern-form-span-2">
                            <label class="modern-form-label" for="recommendations">
                                Recommendations <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper modern-input-wrapper-textarea">
                                <i class="fas fa-lightbulb modern-input-icon modern-input-icon-top"></i>
                                <textarea name="recommendations"
                                    id="recommendations"
                                    class="modern-input modern-textarea {{ $errors->has('recommendations') ? 'is-invalid' : '' }}"
            ...
            <div class="modern-form-actions">
                <a href="{{ route('admin.audits.index') }}" class="btn-modern btn-modern-ghost">
                    Cancel
                </a>
