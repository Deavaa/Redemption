...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Parents</h1>
            <p class="modern-page-subtitle">Manage parent and guardian records</p>
        </div>
        <div class="modern-page-header-right">
            <a href="{{ route('admin.parents.create') }}" class="btn-modern btn-modern-primary">
    ...
    <div class="modern-stats-row">
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                <span class="modern-stat-value">{{ $totalParents }}</span>
                <span class="modern-stat-label">Total Parents</span>
            </div>
        </div>
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                <span class="modern-stat-value">{{ $data->count() }}</span>
    ...
    <div class="modern-card">
        <div class="modern-card-header">
            <div class="modern-card-header-left">
                <h2 class="modern-card-title">All Parents</h2>
                <span class="modern-badge modern-badge-light">{{ $totalParents }} record(s)</span>
            </div>
            <div class="modern-card-header-right">
                <div class="modern-search-box">
                    <i class="fas fa-search"></i>
                    <input type="text" id="parentSearch" placeholder="Search parents..." onkeyup="filterTable()">
                </div>
            </div>
        </div>
        <div class="modern-card-body">
            ...
            <div class="modern-table-wrapper">
                <table class="modern-table" id="parentTable">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="modern-cell-user">
                                    ...
                                    <div class="modern-cell-user-info">
                                        <div class="modern-cell-title">{{ $item->father_name }}</div>
                                        @if($item->father_occupation)
                                            <div class="modern-cell-sub">{{ $item->father_occupation }}</div>
                                        @endif
                                    </div>
                                </div>
                            </td>
                            <td>
                                @if($item->father_phone)
                                    <div class="modern-cell-contact">
                                        <i class="fas fa-phone"></i> {{ $item->father_phone }}
                                    </div>
                                @else
                            ...
                            <td>
                                <span class="modern-cell-text">{{ $item->mother_name ?? '-' }}</span>
                            </td>
                            <td>
                                @if($item->guardian_name)
                                    <span class="modern-cell-text">{{ $item->guardian_name }}</span>
                                @else
                                    <span class="modern-cell-muted">-</span>
                                @endif
                            </td>
                            <td class="td-actions">
                                <div class="modern-action-group">
                                    <a href="{{ route('admin.parents.edit', $item->id) }}" class="modern-btn-icon modern-btn-edit" title="Edit">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <form method="POST" action="{{ route('admin.parents.destroy', $item->id) }}" style="display:inline" onsubmit="return confirm('Are you sure you want to delete this parent?')">
                                        @csrf @method('DELETE')
            ...
            <div class="modern-empty-state">
                ...
                <p>Get started by adding the first parent record.</p>
                <a href="{{ route('admin.parents.create') }}" class="btn-modern btn-modern-primary">
