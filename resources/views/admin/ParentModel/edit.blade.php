...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Edit Parent</h1>
            <p class="modern-page-subtitle">Update details for {{ $item->father_name }}</p>
        </div>
    ...
    <div class="modern-card">
        <form method="POST" action="{{ route('admin.parents.update', $item->id) }}">
            @csrf @method('PUT')
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text" name="father_phone" id="father_phone"
                                    ...
                                    value="{{ old('father_phone', $item->father_phone) }}"
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text" name="father_occupation" id="father_occupation"
                                    ...
                                    value="{{ old('father_occupation', $item->father_occupation) }}"
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text" name="mother_phone" id="mother_phone"
                                    ...
                                    value="{{ old('mother_phone', $item->mother_phone) }}"
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text" name="mother_occupation" id="mother_occupation"
                                    ...
                                    value="{{ old('mother_occupation', $item->mother_occupation) }}"
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text" name="guardian_name" id="guardian_name"
                                    ...
                                    value="{{ old('guardian_name', $item->guardian_name) }}"
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text" name="guardian_relation" id="guardian_relation"
                                    ...
                                    value="{{ old('guardian_relation', $item->guardian_relation) }}"
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text" name="guardian_phone" id="guardian_phone"
                                    ...
                                    value="{{ old('guardian_phone', $item->guardian_phone) }}"
                                    placeholder="e.g. +251 91 234 5678">
                            </div>
