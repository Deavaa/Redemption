            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Update the term name, academic year, and date range</p>
                    </div>
                </div>
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <select name="academic_year_id" id="academic_year_id" class="modern-input modern-select {{ $errors->has('academic_year_id') ? 'is-invalid' : '' }}" required>
                                    ...
                                    @foreach($academicYears as $ay)
                                        <option value="{{ $ay->id }}" {{ old('academic_year_id', $term->academic_year_id) == $ay->id ? 'selected' : '' }}>
                                            {{ $ay->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ old('start_date', $term->start_date ? $term->start_date->format('Y-m-d') : '') }}"
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ old('end_date', $term->end_date ? $term->end_date->format('Y-m-d') : '') }}"
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ old('exam_start_date', $term->exam_start_date ? $term->exam_start_date->format('Y-m-d') : '') }}"
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ old('exam_end_date', $term->exam_end_date ? $term->exam_end_date->format('Y-m-d') : '') }}"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('exam_start_date') && document.getElementById('exam_start_date').value) {
        updateEthiopianDate('exam_start');
    }
    if (document.getElementById('exam_end_date') && document.getElementById('exam_end_date').value) {
        updateEthiopianDate('exam_end');
    }
});
</script>
@endpush
