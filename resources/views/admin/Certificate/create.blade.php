...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Add New Certificate</h1>
            <p class="modern-page-subtitle">Create a new certificate for a student</p>
        </div>
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Enter certificate information and classification</p>
                    </div>
                </div>
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <select name="template" id="template" class="modern-input modern-select">
                                    ...
                                    <option value="formal" {{ old('template') === 'formal' ? 'selected' : '' }}>Formal</option>
