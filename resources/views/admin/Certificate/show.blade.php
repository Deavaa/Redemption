...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            <nav aria-label="breadcrumb" class="modern-breadcrumb">
                <ol>
                    ...
                    <li class="active">{{ $item->certificate_number }}</li>
                </ol>
            </nav>
            <h1 class="modern-page-title">Certificate Details</h1>
            <p class="modern-page-subtitle">Viewing certificate <strong>{{ $item->certificate_number }}</strong></p>
        </div>
        <div class="modern-page-header-right">
            ...
            <a href="{{ route('admin.certificates.edit', $item->id) }}" class="btn-modern btn-modern-primary">
        ...
        <div class="modern-card modern-detail-main">
            ...
            <div class="modern-detail-hero">
                ...
                <div class="modern-detail-hero-info">
                    <h2 class="modern-detail-hero-title">{{ $item->certificate_number }}</h2>
                    <div class="modern-detail-hero-badges">
                        ...
                        @endphp
                        <span class="modern-badge {{ $typeBadge }}"><i class="fas {{ $typeIcon }}"></i> {{ ucfirst($item->type ?? 'N/A') }}</span>
                        @if($item->issue_date && \Carbon\Carbon::parse($item->issue_date)->lte(now()))
                            <span class="modern-badge modern-badge-success"><i class="fas fa-check-circle"></i> Issued</span>
                        @else
            ...
            <div class="modern-detail-section">
                ...
                <div class="modern-detail-body">
                    <div class="modern-detail-row">
                        ...
                        <div class="modern-detail-value">{{ $item->certificate_number ?? '-' }}</div>
                    </div>
                    <div class="modern-detail-row">
                        <div class="modern-detail-label">
                        ...
                        <div class="modern-detail-value">
                            <span class="modern-badge {{ $typeBadge }}">{{ ucfirst($item->type ?? 'N/A') }}</span>
                        </div>
                    </div>
                    <div class="modern-detail-row">
                        <div class="modern-detail-label">
                    ...
                    <div class="modern-detail-row">
                        <div class="modern-detail-label">
                            <i class="fas fa-calendar-alt"></i> Issue Date
                        </div>
                        <div class="modern-detail-value">{{ $item->issue_date ? \Carbon\Carbon::parse($item->issue_date)->format('M d, Y') : '-' }}</div>
                    </div>
                    <div class="modern-detail-row">
                        <div class="modern-detail-label">
                            <i class="fas fa-file-alt"></i> Template
                        </div>
                        <div class="modern-detail-value">{{ ucfirst($item->template ?? 'Default') }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="modern-detail-section">
                <div class="modern-detail-section-header">
                    <i class="fas fa-align-left"></i> Certificate Content
                </div>
                <div class="modern-detail-body">
                    <div class="modern-detail-row">
                        <div class="modern-detail-value" style="white-space: pre-wrap; line-height: 1.6;">
        ...
        <div class="modern-detail-sidebar">
            ...
            <div class="modern-card">
                ...
                <div class="modern-quick-actions">
                    <a href="{{ route('admin.certificates.edit', $item->id) }}" class="modern-quick-action">
                        <i class="fas fa-pen"></i>
                        <span>Edit Certificate</span>
                    </a>
                    <a href="{{ route('admin.certificates.index') }}" class="modern-quick-action">
                        <i class="fas fa-list"></i>
                        <span>View All Certificates</span>
                    </a>
                    <form method="POST" action="{{ route('admin.certificates.destroy', $item->id) }}" onsubmit="return confirm('Are you sure you want to delete this certificate? This action cannot be undone.')">
                        @csrf @method('DELETE')
