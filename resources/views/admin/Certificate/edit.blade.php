...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Edit Certificate</h1>
            <p class="modern-page-subtitle">Update certificate information for <strong>{{ $item->certificate_number }}</strong></p>
        </div>
        <div class="modern-page-header-right">
            <a href="{{ route('admin.certificates.index') }}" class="btn-modern btn-modern-outline">
    ...
    <div class="modern-card">
        <form method="POST" action="{{ route('admin.certificates.update', $item->id) }}">
            @csrf @method('PUT')
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Update certificate information and classification</p>
                    </div>
                </div>
                    ...
                    <div class="modern-form-grid">
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="student_id">
                                Student ID <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text"
                                    name="student_id"
                                    id="student_id"
                                    class="modern-input {{ $errors->has('student_id') ? 'is-invalid' : '' }}"
                                    value="{{ old('student_id', $item->student_id) }}"
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="type">
                                Certificate Type <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                ...
                                <select name="type" id="type" class="modern-input modern-select {{ $errors->has('type') ? 'is-invalid' : '' }}" required>
                                    ...
                                    <option value="character" {{ old('type', $item->type) === 'character' ? 'selected' : '' }}>Character</option>
                                    <option value="transfer" {{ old('type', $item->type) === 'transfer' ? 'selected' : '' }}>Transfer</option>
                                    <option value="experience" {{ old('type', $item->type) === 'experience' ? 'selected' : '' }}>Experience</option>
                                    <option value="achievement" {{ old('type', $item->type) === 'achievement' ? 'selected' : '' }}>Achievement</option>
                                    <option value="completion" {{ old('type', $item->type) === 'completion' ? 'selected' : '' }}>Completion</option>
                                </select>
                            </div>
                            @error('type')
                                <span class="modern-form-error">{{ $message }}</span>
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="certificate_number">
                                Certificate Number <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text"
                                    ...
                                    class="modern-input {{ $errors->has('certificate_number') ? 'is-invalid' : '' }}"
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="issue_date">
                                Issue Date <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                ...
                                <input type="date"
                                    name="issue_date"
                                    id="issue_date"
                                    class="modern-input {{ $errors->has('issue_date') ? 'is-invalid' : '' }}"
                                    value="{{ old('issue_date', $item->issue_date ? $item->issue_date->format('Y-m-d') : '') }}"
                                    required>
                            </div>
                            @error('issue_date')
                                <span class="modern-form-error">{{ $message }}</span>
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="template">
                                Template <small>(optional)</small>
                            </label>
                            <div class="modern-input-wrapper">
                                <i class="fas fa-file-alt modern-input-icon"></i>
                                <select name="template" id="template" class="modern-input modern-select">
                                    <option value="default" {{ old('template', $item->template ?? 'default') === 'default' ? 'selected' : '' }}>Default</option>
                                    <option value="formal" {{ old('template', $item->template ?? 'default') === 'formal' ? 'selected' : '' }}>Formal</option>
                                    <option value="modern" {{ old('template', $item->template ?? 'default') === 'modern' ? 'selected' : '' }}>Modern</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="modern-form-group modern-form-span-2">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <textarea
                                    ...
                                    placeholder="Certificate body content..."
            ...
            <div class="modern-form-actions">
                <a href="{{ route('admin.certificates.index') }}" class="btn-modern btn-modern-ghost">
                    Cancel
                </a>
...
.modern-form-section-icon-purple { background: #f5f3ff; color: #8b5cf6; }
