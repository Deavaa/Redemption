...
@section('title', 'Add Finance Statement')
...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Add Finance Statement</h1>
            <p class="modern-page-subtitle">Create a new financial statement record</p>
        </div>
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <select name="statement_type" id="statement_type" class="modern-input modern-select {{ $errors->has('statement_type') ? 'is-invalid' : '' }}" required>
                                    ...
                                    <option value="income_statement" {{ old('statement_type') === 'income_statement' ? 'selected' : '' }}>Income Statement</option>
                                    <option value="balance_sheet" {{ old('statement_type') === 'balance_sheet' ? 'selected' : '' }}>Balance Sheet</option>
                                    <option value="cash_flow" {{ old('statement_type') === 'cash_flow' ? 'selected' : '' }}>Cash Flow</option>
                                    <option value="trial_balance" {{ old('statement_type') === 'trial_balance' ? 'selected' : '' }}>Trial Balance</option>
                                </select>
                            </div>
