...
<div class="modern-page">
    <div class="modern-page-header">
        ...
        <div class="modern-page-header-right">
            <a href="{{ route('admin.teacher-evaluations.analysis') }}" class="btn-modern btn-modern-outline">
                <i class="fas fa-chart-line"></i><span>Analysis</span>
            </a>
            <a href="{{ route('admin.teacher-evaluations.create') }}" class="btn-modern btn-modern-primary">
                <i class="fas fa-plus"></i><span>New Evaluation</span>
            </a>
        </div>
    </div>
    ...
    <div class="modern-stats-row">
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info"><span class="modern-stat-value">{{ $stats['total'] }}</span><span class="modern-stat-label">Total Evaluations</span></div>
        </div>
        <div class="modern-stat-card">
    ...
    <div class="modern-card" style="margin-bottom:1.5rem;">
        <form method="GET" action="{{ route('admin.teacher-evaluations.index') }}" style="padding:1rem 1.5rem;display:flex;gap:.75rem;flex-wrap:wrap;align-items:center;">
            ...
            <select name="department_id" class="modern-filter-select">
    ...
    <div class="modern-card">
        <div class="modern-card-header">
            <div class="modern-card-header-left">
                <h2 class="modern-card-title">Evaluations</h2>
                <span class="modern-badge modern-badge-light">{{ $evaluations->total() }} records</span>
            </div>
        </div>
        <div class="modern-card-body">
            ...
            <div class="modern-table-wrapper">
                <table class="modern-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><div class="modern-cell-title">{{ $eval->teacher->full_name ?? '-' }}</div></td>
                            ...
                            <td class="td-actions">
                                <div class="modern-action-group">
                                    <a href="{{ route('admin.teacher-evaluations.show', $eval->id) }}" class="modern-btn-icon modern-btn-view" title="View"><i class="fas fa-eye"></i></a>
                                    <a href="{{ route('admin.teacher-evaluations.edit', $eval->id) }}" class="modern-btn-icon modern-btn-edit" title="Edit"><i class="fas fa-pen"></i></a>
                                    <form method="POST" action="{{ route('admin.teacher-evaluations.destroy', $eval->id) }}" style="display:inline" onsubmit="return confirm('Delete this evaluation?')">
                                        @csrf @method('DELETE')
            ...
            <div class="modern-pagination-wrapper">{{ $evaluations->withQueryString()->links() }}</div>
            @endif
            @else
            <div class="modern-empty-state">
                <div class="modern-empty-icon"><i class="fas fa-clipboard-list"></i></div>
                <h3>No Evaluations</h3>
                <p>Start by evaluating a teacher's performance.</p>
                <a href="{{ route('admin.teacher-evaluations.create') }}" class="btn-modern btn-modern-primary"><i class="fas fa-plus"></i> New Evaluation</a>
            </div>
            @endif
        </div>
    </div>
