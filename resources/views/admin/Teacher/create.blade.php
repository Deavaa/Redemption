            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Enter the teacher's name and contact details</p>
                    </div>
                </div>
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Qualification, department, and employment info</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <select name="branch_id" id="branch_id" class="modern-input modern-select {{ $errors->has('branch_id') ? 'is-invalid' : '' }}" required
                                    ...
                                    @foreach($branches as $branch)
                                        <option value="{{ $branch->id }}" {{ ($isBranchPrincipal && $authBranchId == $branch->id) || old('branch_id') == $branch->id ? 'selected' : '' }}>{{ $branch->name }}</option>
                                    @endforeach
                                </select>
