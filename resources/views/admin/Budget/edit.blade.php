...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Edit Budget</h1>
            <p class="modern-page-subtitle">Update budget for <strong>{{ ucfirst($item->category ?? '') }}</strong></p>
        </div>
    ...
    <div class="modern-card">
        <form method="POST" action="{{ route('admin.budgets.update', $item->id) }}">
            @csrf @method('PUT')
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Update the budget category and allocation</p>
                    </div>
                </div>
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="number"
                                    ...
                                    value="{{ old('spent_amount', $item->spent_amount) }}"
                                    placeholder="0.00">
                            </div>
                            @error('spent_amount')
                                <span class="modern-form-error">{{ $message }}</span>
