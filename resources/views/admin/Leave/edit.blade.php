...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Edit Leave</h1>
            <p class="modern-page-subtitle">Update leave request information for <strong>{{ $item->employee?->name ?? 'Employee #' . $item->employee_id }}</strong></p>
        </div>
    ...
    <div class="modern-card">
        <form method="POST" action="{{ route('admin.leaves.update', $item->id) }}">
            @csrf @method('PUT')
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Update the employee and type of leave</p>
                    </div>
                </div>
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <select name="leave_type" id="leave_type" class="modern-select {{ $errors->has('leave_type') ? 'is-invalid' : '' }}" required>
                                    ...
                                    <option value="sick" {{ old('leave_type', $item->leave_type) == 'sick' ? 'selected' : '' }}>Sick Leave</option>
                                    <option value="annual" {{ old('leave_type', $item->leave_type) == 'annual' ? 'selected' : '' }}>Annual Leave</option>
                                    <option value="emergency" {{ old('leave_type', $item->leave_type) == 'emergency' ? 'selected' : '' }}>Emergency Leave</option>
                                    <option value="maternity" {{ old('leave_type', $item->leave_type) == 'maternity' ? 'selected' : '' }}>Maternity Leave</option>
                                    <option value="paternity" {{ old('leave_type', $item->leave_type) == 'paternity' ? 'selected' : '' }}>Paternity Leave</option>
                                </select>
                            </div>
                            @error('leave_type')
                                <span class="modern-form-error">{{ $message }}</span>
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Update the start and end dates for the leave</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="number"
                                    ...
                                    value="{{ old('total_days', $item->total_days) }}"
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Update the leave reason and status</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                        <div class="modern-form-group modern-form-span-2">
                            ...
                            <textarea name="reason"
                                ...
                                rows="4"
                                placeholder="Describe the reason for the leave...">{{ old('reason', $item->reason) }}</textarea>
                            @error('reason')
                                <span class="modern-form-error">{{ $message }}</span>
                            @enderror
                        </div>
