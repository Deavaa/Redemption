...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Leaves</h1>
            <p class="modern-page-subtitle">Manage employee leave requests</p>
        </div>
        <div class="modern-page-header-right">
            <a href="{{ route('admin.leaves.create') }}" class="btn-modern btn-modern-primary">
    ...
    <div class="modern-stats-row">
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                ...
                <span class="modern-stat-label">Total Leaves</span>
            </div>
        </div>
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                <span class="modern-stat-value">{{ $data->where('status', 'pending')->count() }}</span>
        ...
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                <span class="modern-stat-value">{{ $data->where('status', 'approved')->count() }}</span>
        ...
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                <span class="modern-stat-value">{{ $data->where('status', 'rejected')->count() }}</span>
    ...
    <div class="modern-card">
        <div class="modern-card-header">
            <div class="modern-card-header-left">
                <h2 class="modern-card-title">All Leaves</h2>
                <span class="modern-badge modern-badge-light">{{ $data->total() }} records</span>
            </div>
            <div class="modern-card-header-right">
                <div class="modern-search-box">
                    <i class="fas fa-search"></i>
                    <input type="text" id="leaveSearch" placeholder="Search leaves..." onkeyup="filterTable()">
                </div>
            </div>
        </div>
        <div class="modern-card-body">
                ...
                <table class="modern-table" id="leaveTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="modern-cell-title">{{ $item->employee?->name ?? 'Employee #' . $item->employee_id }}</div>
                            </td>
                            <td>
                                <div class="modern-cell-text">
                                    @php
                                        $leaveTypeLabel = match($item->leave_type ?? '') {
                                            ...
                                            default => ucfirst($item->leave_type ?? 'N/A')
                                        };
                                    @endphp
                                    {{ $leaveTypeLabel }}
                                </div>
                            ...
                            <td class="td-center">
                                <span class="modern-badge modern-badge-light">{{ $item->total_days ?? '-' }}</span>
                            </td>
                            <td class="td-center">
                                @if($item->status === 'approved')
                                    <span class="modern-badge modern-badge-success"><i class="fas fa-check"></i> Approved</span>
                                @elseif($item->status === 'rejected')
                                    <span class="modern-badge modern-badge-danger"><i class="fas fa-times"></i> Rejected</span>
                            ...
                            <td class="td-actions">
                                <div class="modern-action-group">
                                    <a href="{{ route('admin.leaves.show', $item->id) }}" class="modern-btn-icon modern-btn-view" title="View">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.leaves.edit', $item->id) }}" class="modern-btn-icon modern-btn-edit" title="Edit">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <form method="POST" action="{{ route('admin.leaves.destroy', $item->id) }}" style="display:inline" onsubmit="return confirm('Are you sure you want to delete this leave record?')">
                                        @csrf @method('DELETE')
            ...
            <div class="modern-empty-state">
                ...
                <p>Get started by adding the first leave request.</p>
                <a href="{{ route('admin.leaves.create') }}" class="btn-modern btn-modern-primary">
...
.modern-btn-view:hover { background: #2563eb; color: #fff; transform: translateY(-1px); }
