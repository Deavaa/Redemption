...
@section('title', 'Edit Income/Expense')
...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Edit Record</h1>
            <p class="modern-page-subtitle">Update <strong>{{ ucfirst($item->type ?? '') }} - {{ ucfirst($item->category ?? '') }}</strong></p>
        </div>
    ...
    <div class="modern-card">
        <form method="POST" action="{{ route('admin.income-expenses.update', $item->id) }}">
            @csrf @method('PUT')
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Update the transaction type and amount</p>
                    </div>
                </div>
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ old('date', $item->date ? $item->date->format('Y-m-d') : '') }}"
                                    required>
                            </div>
                            @error('date')
                                <span class="modern-form-error">{{ $message }}</span>
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Update reference and description details</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
