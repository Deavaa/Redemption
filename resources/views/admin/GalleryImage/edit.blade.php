...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Edit Image</h1>
            <p class="modern-page-subtitle">Update image information for <strong>{{ $item->title }}</strong></p>
        </div>
    ...
    <div class="modern-card">
        <form method="POST" action="{{ route('admin.gallery-images.update', $item->id) }}" enctype="multipart/form-data">
            @csrf @method('PUT')
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        <h3 class="modern-form-section-title">Image Details</h3>
                        <p class="modern-form-section-desc">Update image title, category, and description</p>
                    </div>
                </div>
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Replace image file or update display options</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
            ...
            <div class="modern-form-actions">
                <a href="{{ route('admin.gallery-images.index') }}" class="btn-modern btn-modern-ghost">
                    Cancel
                </a>
...
@media (max-width: 768px) {
    ...
    .modern-current-img { max-width: 100%; }
}
</style>
@endpush
@endsection
