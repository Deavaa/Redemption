        ...
        <div class="modern-page-header-left">
            <nav aria-label="breadcrumb" class="modern-breadcrumb">
                <ol>
                    ...
                    <li><a href="{{ route('admin.gallery-images.index') }}">Gallery Images</a></li>
                    <li class="active">{{ $item->title }}</li>
                </ol>
            </nav>
            <h1 class="modern-page-title">Image Details</h1>
            <p class="modern-page-subtitle">Viewing image <strong>{{ $item->title }}</strong></p>
        </div>
        <div class="modern-page-header-right">
            <a href="{{ route('admin.gallery-images.index') }}" class="btn-modern btn-modern-outline">
                <i class="fas fa-arrow-left"></i>
                <span>Back to List</span>
            </a>
            <a href="{{ route('admin.gallery-images.edit', $item->id) }}" class="btn-modern btn-modern-primary">
    ...
    <div class="modern-detail-grid">
        ...
        <div class="modern-card modern-detail-main">
            ...
            <div class="modern-detail-hero">
                @if($item->image_path)
                    <img src="{{ asset('storage/' . $item->image_path) }}" alt="{{ $item->title }}" class="modern-detail-hero-avatar">
                @else
                ...
                <div class="modern-detail-hero-info">
                    <h2 class="modern-detail-hero-title">{{ $item->title }}</h2>
                    <div class="modern-detail-hero-badges">
                        ...
                        @endif
                        @if($item->category)
                            <span class="modern-badge modern-badge-info"><i class="fas fa-folder"></i> {{ $item->category }}</span>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="modern-detail-section">
                ...
                <div class="modern-detail-body">
                    <div class="modern-detail-row">
                        ...
                        <div class="modern-detail-value">{{ $item->title ?? '-' }}</div>
                    </div>
                    <div class="modern-detail-row">
                        <div class="modern-detail-label">
                    ...
                    <div class="modern-detail-row">
                        ...
                        <div class="modern-detail-value">
                            <code style="background: #f3f4f6; padding: 0.2rem 0.5rem; border-radius: 6px; font-size: 0.82rem; color: #4361ee;">{{ $item->image_path ?? '-' }}</code>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modern-detail-sidebar">
            ...
            <div class="modern-card">
                ...
                <div class="modern-quick-actions">
                    <a href="{{ route('admin.gallery-images.edit', $item->id) }}" class="modern-quick-action">
                        <i class="fas fa-pen"></i>
                        <span>Edit Image</span>
                    </a>
                    <a href="{{ route('admin.gallery-images.index') }}" class="modern-quick-action">
                        <i class="fas fa-list"></i>
                        <span>View All Images</span>
                    </a>
                    <form method="POST" action="{{ route('admin.gallery-images.destroy', $item->id) }}" onsubmit="return confirm('Are you sure you want to delete this image? This action cannot be undone.')">
                        @csrf @method('DELETE')
            ...
            <div class="modern-card">
                ...
                <div class="modern-photo-card">
                    <img src="{{ asset('storage/' . $item->image_path) }}" alt="{{ $item->title }}" class="modern-photo-img">
                </div>
            </div>
            @endif
