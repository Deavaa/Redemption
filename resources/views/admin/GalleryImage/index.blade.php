...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Gallery Images</h1>
            <p class="modern-page-subtitle">Manage website gallery images and photos</p>
        </div>
        <div class="modern-page-header-right">
            <a href="{{ route('admin.gallery-images.create') }}" class="btn-modern btn-modern-primary">
    ...
    <div class="modern-stats-row">
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                ...
                <span class="modern-stat-label">Total Images</span>
            </div>
        </div>
        <div class="modern-stat-card">
        ...
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                <span class="modern-stat-value">{{ $data->pluck('category')->filter()->unique()->count() }}</span>
        ...
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                <span class="modern-stat-value">{{ $data->where('is_active', false)->count() }}</span>
    ...
    <div class="modern-card">
        <div class="modern-card-header">
            <div class="modern-card-header-left">
                <h2 class="modern-card-title">All Images</h2>
                <span class="modern-badge modern-badge-light">{{ $data->total() }} records</span>
            </div>
            <div class="modern-card-header-right">
                <div class="modern-search-box">
                    <i class="fas fa-search"></i>
                    <input type="text" id="imageSearch" placeholder="Search images..." onkeyup="filterTable()">
                </div>
            </div>
        </div>
        <div class="modern-card-body">
            ...
            <div class="modern-table-wrapper">
                <table class="modern-table" id="imageTable">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($item->image_path)
                                    <img src="{{ asset('storage/' . $item->image_path) }}" alt="{{ $item->title }}" class="modern-thumbnail">
                                @else
                                    <div class="modern-thumbnail-placeholder">
                            ...
                            <td>
                                ...
                                @if($item->description)
                                    <div class="modern-cell-sub">{{ \Illuminate\Support\Str::limit($item->description, 50) }}</div>
                                @endif
                            </td>
                            <td>
                                @if($item->category)
                            ...
                            <td class="td-center">
                                <span class="modern-cell-text">{{ $item->sort_order ?? 0 }}</span>
                            </td>
                            <td class="td-actions">
                                <div class="modern-action-group">
                                    <a href="{{ route('admin.gallery-images.show', $item->id) }}" class="modern-btn-icon modern-btn-view" title="View">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.gallery-images.edit', $item->id) }}" class="modern-btn-icon modern-btn-edit" title="Edit">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <form method="POST" action="{{ route('admin.gallery-images.destroy', $item->id) }}" style="display:inline" onsubmit="return confirm('Are you sure you want to delete this image?')">
                                        @csrf @method('DELETE')
            ...
            <div class="modern-empty-state">
                ...
                <h3>No Images Yet</h3>
                <p>Get started by adding your first gallery image.</p>
                <a href="{{ route('admin.gallery-images.create') }}" class="btn-modern btn-modern-primary">
