...
<div class="modern-page">
    ...
    <form method="POST" action="{{ route('admin.employee-assets.update', $item->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="modern-form-section">
            <div class="modern-form-section-header">
                ...
                <div>
                    ...
                    <p class="modern-form-section-desc">Update the asset details and assignment info</p>
                </div>
            </div>
                ...
                <div class="modern-form-grid">
                    <div class="modern-form-group">
                        ...
                        <div class="modern-input-wrapper">
                            ...
                            <input type="text" name="name" class="modern-input" value="{{ old('name', $item->name ?? '') }}" placeholder="Enter asset name" required>
                        </div>
                        @error('name')
                    ...
                    <div class="modern-form-group">
                        ...
                        <div class="modern-input-wrapper">
                            ...
                            <input type="text" name="employee_id" class="modern-input" value="{{ old('employee_id', $item->employee_id ?? '') }}" placeholder="Enter employee ID" required>
                        </div>
                        @error('employee_id')
                            <div class="modern-form-error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="modern-form-group">
                        ...
                        <div class="modern-input-wrapper">
                            ...
                            <input type="number" name="quantity" class="modern-input" value="{{ old('quantity', $item->quantity ?? '') }}" placeholder="Enter quantity" required min="1">
                        </div>
                        @error('quantity')
                            <div class="modern-form-error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="modern-form-group">
                        ...
                        <div class="modern-input-wrapper">
                            ...
                            <input type="date" name="issue_date" class="modern-input" value="{{ old('issue_date', $item->issue_date ? $item->issue_date->format('Y-m-d') : '') }}" required>
                        </div>
                        @error('issue_date')
                            <div class="modern-form-error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="modern-form-group">
                        ...
                        <div class="modern-input-wrapper">
                            ...
                            <input type="date" name="return_date" class="modern-input" value="{{ old('return_date', $item->return_date ? $item->return_date->format('Y-m-d') : '') }}">
                        </div>
                        @error('return_date')
                            <div class="modern-form-error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="modern-form-group modern-form-span-2">
                        ...
                        <textarea name="description" class="modern-textarea" rows="3" placeholder="Enter asset description">{{ old('description', $item->description ?? '') }}</textarea>
                        @error('description')
                            <div class="modern-form-error">{{ $message }}</div>
                        @enderror
                    </div>
