...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Fees</h1>
            <p class="modern-page-subtitle">Manage fee structures and schedules</p>
        </div>
        <div class="modern-page-header-right">
            <a href="{{ route('admin.fees.create') }}" class="btn-modern btn-modern-primary">
    ...
    <div class="modern-stats-row">
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                <span class="modern-stat-value">{{ $totalFees ?? $data->total() }}</span>
                <span class="modern-stat-label">Total Fees</span>
            </div>
        </div>
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                <span class="modern-stat-value">{{ number_format($totalAmount ?? 0, 2) }}</span>
                <span class="modern-stat-label">Total Amount</span>
            </div>
        </div>
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                ...
                <span class="modern-stat-label">Active Fees</span>
            </div>
        </div>
    </div>
    ...
    <div class="modern-card">
        <div class="modern-card-header">
            <div class="modern-card-header-left">
                <h2 class="modern-card-title">All Fees</h2>
                <span class="modern-badge modern-badge-light">{{ $data->total() }} records</span>
            </div>
            <div class="modern-card-header-right">
                <div class="modern-search-box">
                    <i class="fas fa-search"></i>
                    <input type="text" id="feeSearch" placeholder="Search fees..." onkeyup="filterTable()">
                </div>
            </div>
        </div>
        <div class="modern-card-body">
            ...
            <div class="modern-table-wrapper">
                <table class="modern-table" id="feeTable">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr class="modern-table-row">
                            ...
                            <td>
                                <div class="modern-cell-title">{{ ucfirst($item->fee_type ?? '-') }}</div>
                                @if($item->description)
                            ...
                            <td class="td-center">
                                <span class="modern-cell-amount">{{ number_format($item->amount, 2) }}</span>
                            </td>
                            <td class="td-center">
                                <div class="modern-cell-text">{{ $item->due_date ? $item->due_date->format('M d, Y') : '-' }}</div>
                            </td>
                            <td class="td-center">
                                @if($item->is_active)
                            ...
                            <td class="td-actions">
                                <div class="modern-action-group">
                                    <a href="{{ route('admin.fees.edit', $item->id) }}" class="modern-btn-icon modern-btn-edit" title="Edit">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <form method="POST" action="{{ route('admin.fees.destroy', $item->id) }}" style="display:inline" onsubmit="return confirm('Are you sure you want to delete this fee?')">
                                        @csrf @method('DELETE')
            ...
            <div class="modern-empty-state">
                ...
                <h3>No Fees Yet</h3>
                <p>Get started by adding your first fee structure.</p>
                <a href="{{ route('admin.fees.create') }}" class="btn-modern btn-modern-primary">
