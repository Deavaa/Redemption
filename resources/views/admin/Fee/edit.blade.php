...
<div class="modern-page">
    ...
    <div class="modern-card">
        <form method="POST" action="{{ route('admin.fees.update', $item->id) }}">
            @csrf @method('PUT')
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Update the fee type and amount</p>
                    </div>
                </div>
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <select name="fee_type" id="fee_type" class="modern-input modern-select {{ $errors->has('fee_type') ? 'is-invalid' : '' }}" required>
                                    ...
                                    <option value="tuition" {{ old('fee_type', $item->fee_type) == 'tuition' ? 'selected' : '' }}>Tuition</option>
                                    <option value="registration" {{ old('fee_type', $item->fee_type) == 'registration' ? 'selected' : '' }}>Registration</option>
                                    <option value="exam" {{ old('fee_type', $item->fee_type) == 'exam' ? 'selected' : '' }}>Exam</option>
                                    <option value="library" {{ old('fee_type', $item->fee_type) == 'library' ? 'selected' : '' }}>Library</option>
                                    <option value="lab" {{ old('fee_type', $item->fee_type) == 'lab' ? 'selected' : '' }}>Lab</option>
                                    <option value="transport" {{ old('fee_type', $item->fee_type) == 'transport' ? 'selected' : '' }}>Transport</option>
                                    <option value="activity" {{ old('fee_type', $item->fee_type) == 'activity' ? 'selected' : '' }}>Activity</option>
                                    <option value="other" {{ old('fee_type', $item->fee_type) == 'other' ? 'selected' : '' }}>Other</option>
                                </select>
                            </div>
                            @error('fee_type')
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <select name="enrollment_type" id="enrollment_type" class="modern-input modern-select {{ $errors->has('enrollment_type') ? 'is-invalid' : '' }}">
                                    @foreach($enrollmentTypes as $value => $label)
                                        <option value="{{ $value }}" {{ old('enrollment_type', $item->enrollment_type ?? 'all') == $value ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
