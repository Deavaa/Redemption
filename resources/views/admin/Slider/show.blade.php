...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <p class="modern-page-subtitle">Slider details and information</p>
        </div>
        <div class="modern-page-header-right">
            ...
            <a href="{{ route('admin.sliders.edit', $item->id) }}" class="btn-modern btn-modern-primary">
            ...
            <div class="modern-detail-body">
                <div class="modern-detail-row">
                    <div class="modern-detail-label">
                        <i class="fas fa-font"></i> Subtitle
                    </div>
                ...
                <div class="modern-detail-row">
                    <div class="modern-detail-label">
                        <i class="fas fa-image"></i> Image Path
                    </div>
                    <div class="modern-detail-value">
                        @if($item->image_path)
                            {{ $item->image_path }}
                ...
                <div class="modern-detail-row">
                    ...
                    <div class="modern-detail-value">
                        @if($item->link)
                            <a href="{{ $item->link }}" class="modern-link" target="_blank">{{ $item->link }}</a>
                        @else
                            <span class="modern-muted">-</span>
                        @endif
                    </div>
        ...
        <div class="modern-detail-sidebar">
            ...
            <div class="modern-card">
                ...
                <div style="padding: 1rem; text-align: center;">
                    <img src="{{ asset($item->image_path) }}" alt="{{ $item->title }}" style="max-width: 100%; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);" onerror="this.style.display='none'; this.parentElement.innerHTML='<div style=&quot;padding:2rem;color:#d1d5db;&quot;><i class=&quot;fas fa-image&quot; style=&quot;font-size:2rem;&quot;></i><p style=&quot;margin:0.5rem 0 0;font-size:0.85rem;&quot;>Image not found</p></div>';">
                </div>
            </div>
            @endif
            ...
            <div class="modern-card">
                ...
                <div class="modern-quick-actions">
                    <a href="{{ route('admin.sliders.edit', $item->id) }}" class="modern-quick-action">
                        <i class="fas fa-pen"></i>
                        <span>Edit Slider</span>
                    </a>
                    @if($item->link)
                    <a href="{{ $item->link }}" target="_blank" class="modern-quick-action">
                        <i class="fas fa-external-link-alt"></i>
                        <span>Open Link</span>
                    </a>
                    @endif
                    <form method="POST" action="{{ route('admin.sliders.destroy', $item->id) }}" onsubmit="return confirm('Are you sure you want to delete this slider? This action cannot be undone.')">
                        @csrf @method('DELETE')
