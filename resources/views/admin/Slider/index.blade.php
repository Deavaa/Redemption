...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Sliders</h1>
            <p class="modern-page-subtitle">Manage homepage slider banners</p>
        </div>
        <div class="modern-page-header-right">
            <a href="{{ route('admin.sliders.create') }}" class="btn-modern btn-modern-primary">
    ...
    <div class="modern-stats-row">
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                ...
                <span class="modern-stat-label">Total Sliders</span>
            </div>
        </div>
        <div class="modern-stat-card">
    ...
    <div class="modern-card">
        <div class="modern-card-header">
            <div class="modern-card-header-left">
                <h2 class="modern-card-title">All Sliders</h2>
                <span class="modern-badge modern-badge-light">{{ $data->total() }} records</span>
            </div>
            <div class="modern-card-header-right">
                <div class="modern-search-box">
                    <i class="fas fa-search"></i>
                    <input type="text" id="sliderSearch" placeholder="Search sliders..." onkeyup="filterTable()">
                </div>
            </div>
        </div>
        <div class="modern-card-body">
            ...
            <div class="modern-table-wrapper">
                <table class="modern-table" id="sliderTable">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr class="modern-table-row">
                            ...
                            <td>
                                <div class="modern-cell-text">{{ $item->subtitle ?? '-' }}</div>
                            </td>
                            <td>
                                @if($item->image_path)
                                    <span class="modern-cell-text">{{ \Illuminate\Support\Str::limit(basename($item->image_path), 25) }}</span>
                                @else
                            ...
                            <td>
                                @if($item->link)
                                    <a href="{{ $item->link }}" class="modern-link" target="_blank">
                            ...
                            <td class="td-actions">
                                <div class="modern-action-group">
                                    <a href="{{ route('admin.sliders.show', $item->id) }}" class="modern-btn-icon modern-btn-view" title="View">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.sliders.edit', $item->id) }}" class="modern-btn-icon modern-btn-edit" title="Edit">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <form method="POST" action="{{ route('admin.sliders.destroy', $item->id) }}" style="display:inline" onsubmit="return confirm('Are you sure you want to delete this slider?')">
                                        @csrf @method('DELETE')
            ...
            <div class="modern-empty-state">
                ...
                <p>Get started by adding your first slider banner.</p>
                <a href="{{ route('admin.sliders.create') }}" class="btn-modern btn-modern-primary">
...
function filterTable() {
    const input = document.getElementById('sliderSearch');
