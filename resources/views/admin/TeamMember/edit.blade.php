            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Update the team member's name and professional details</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                        ...
                        <div class="modern-form-group">
                            ...
                            <small class="text-muted mt-1">Images are automatically compressed. Large photos (up to 50MB) are accepted.</small>
                            @error('photo')
                                <span class="modern-form-error">{{ $message }}</span>
                            @enderror
                        </div>
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Update contact details for the team member</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Update bio and configure visibility on the website</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                        <div class="modern-form-group modern-form-span-2">
                            ...
                            <textarea name="bio"
                                ...
                                style="padding-left:2.5rem;resize:vertical;">{{ old('bio', $item->bio) }}</textarea>
                        </div>
