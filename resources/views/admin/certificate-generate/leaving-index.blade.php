...
@section('title', 'School Leaving Clearance Certificate')
...
<div class="modern-page">
    <div class="modern-page-header" style="margin-bottom:0.75rem;">
        <div class="modern-page-header-left" style="display:flex;align-items:center;gap:10px;">
            ...
            <h1 style="font-size:0.85rem;font-weight:700;color:var(--text-dark);margin:0;">School Leaving Clearance Certificate</h1>
        </div>
        <div class="modern-page-header-right">
            ...
            <button type="submit" class="btn-modern btn-modern-primary" id="generateBtnTop" disabled form="leavingForm" style="font-size:0.7rem;padding:4px 12px;">
                <i class="fas fa-file-signature"></i> Generate
            </button>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.leaving-certificate.generate') }}" target="_blank" id="leavingForm">
        @csrf
        ...
        {{-- Step 3: Leaving Details --}}
        <div class="modern-card" style="margin-bottom:10px;">
            <div class="certgen-toolbar">
                <span class="certgen-toolbar-label">Leaving Details</span>
            </div>
            <div style="padding:12px 14px;">
                <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px;">
                    <div class="modern-form-group">
                        <label class="modern-label" style="font-size:10px;font-weight:600;margin-bottom:4px;display:block;">Leaving Date</label>
                        <input type="date" name="leaving_date" value="{{ now()->format('Y-m-d') }}" class="modern-input" style="font-size:11px;padding:5px 8px;">
                    </div>
                    <div class="modern-form-group">
                        <label class="modern-label" style="font-size:10px;font-weight:600;margin-bottom:4px;display:block;">Reason for Leaving</label>
                        <select name="reason" class="modern-input" style="font-size:11px;padding:5px 8px;">
                            <option value="Transfer">Transfer to Another School</option>
                            <option value="Completion">Completed Studies</option>
                            <option value="Withdrawal">Withdrawal by Parent/Guardian</option>
                    ...
                    <div class="modern-form-group">
                        <label class="modern-label" style="font-size:10px;font-weight:600;margin-bottom:4px;display:block;">Conduct Assessment</label>
                        <select name="conduct" class="modern-input" style="font-size:11px;padding:5px 8px;">
        ...
        <div class="modern-card">
            <div class="modern-form-actions">
                ...
                <button type="submit" class="btn-modern btn-modern-primary" id="generateBtn" disabled>
                    <i class="fas fa-file-signature"></i> Generate Leaving Certificate
                </button>
            </div>
        </div>
    </form>
...
(function() {
    ...
    function loadStudents() {
        ...
        fetch('{{ route("admin.leaving-certificate.students") }}?' + params)
    ...
    document.getElementById('leavingForm')?.addEventListener('submit', function(e) {
