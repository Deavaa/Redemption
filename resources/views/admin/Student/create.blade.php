...
@section('content')
    <div class="container-fluid py-1">
        ...
        <form action="{{ route('admin.students.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="tab-content" id="studentTabContent">
                                ...
                                <div class="col-lg-3">
                                    <div class="card border-0 shadow-sm h-100">
                                        <div class="card-body text-center">
                                            <img id="photoPreview"
                                                src="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTIwIiBoZWlnaHQ9IjEyMCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cmVjdCB3aWR0aD0iMTIwIiBoZWlnaHQ9IjEyMCIgZmlsbD0iI2NjYyIvPjx0ZXh0IHg9IjYwIiB5PSI2MCIgdGV4dC1hbmNob3I9Im1pZGRsZSIgZmlsbD0iIzk5OSI+U3R1ZGVudDwvdGV4dD48L3N2Zz4="
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="admission_number"
                                        ...
                                        value="{{ old('admission_number') }}" placeholder="Auto-generated" readonly>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="roll_number"
                                        ...
                                        value="{{ old('roll_number') }}" placeholder="Auto-generated" readonly>
                                    <small class="text-muted">Auto-generated</small>
                                    @error('roll_number')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="notes" class="form-control form-control-sm @error('notes') is-invalid @enderror" rows="2">{{ old('notes') }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                ...
                <div class="tab-pane fade" id="comments" role="tabpanel" aria-labelledby="comments-tab">
                    <div class="card border-0 shadow-sm mt-3">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <label class="form-label">Teacher Comments (Read Only)</label>
                                <textarea class="form-control" rows="3" readonly>No comments available for new students.</textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Admin Staff Comments (Read Only)</label>
                                <textarea class="form-control" rows="3" readonly>No comments available for new students.</textarea>
                            </div>
                            <div class="mb-3">
            ...
            <!-- Submit Buttons -->
            <div class="mt-4">
                <button type="submit" class="btn btn-warning btn-sm px-4"><i class="bi bi-check-lg me-1"></i>Save
                    Student</button>
    ...
    <!-- JavaScript for Ethiopian Date Conversion & Age Calculation -->
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Simple Ethiopian date conversion (approximate)
    ...
    <script>
        // Class-Section dependency and search
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (classSelect && sectionSelect) {
                classSelect.addEventListener('change', function() {
                    ...
                    // Filter sections that belong to selected class
                    ...
                    // Enable search on section select
                    enableSearch(sectionSelect);
                });

                // Initialize search on both selects
            ...
            function enableSearch(select) {
                if (select.options.length > 10) {
                    select.setAttribute('data-enable-search', 'true');
    ...
    <script>
        // Guardian selection and auto-fill
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (guardianSelect) {
                ...
                // Enable search
                // if (guardianSelect.options.length > 5) {
                //     enableSearch(guardianSelect);
                // }
            }

            // Save new parent via AJAX (simplified)
            if (saveParentBtn) {
                saveParentBtn.addEventListener('click', function() {
                    ...
                    const email = document.getElementById('new_parent_email').value;
                    const address = document.getElementById('new_parent_address').value;
                    ...
                    // Simulate AJAX call - in real implementation you would POST to a route
                    // For now, just add to dropdown and close modal
                    const newOption = document.createElement('option');
                    newOption.value = 'temp'; // temporary ID
