...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Edit Student</h1>
                ...
                <div class="modern-form-section">
                    <div class="modern-form-section-header">
                        ...
                        <div>
                            ...
                            <p class="modern-form-section-desc">Update the student's personal details and photo</p>
                        </div>
                    </div>
                ...
                <div class="modern-form-section">
                    <div class="modern-form-section-header">
                        ...
                        <div>
                            ...
                            <p class="modern-form-section-desc">Update enrollment details, class assignment and academic year</p>
                        </div>
                    </div>
                    <div class="modern-form-section-body">
                        <div class="modern-form-grid">
                            ...
                            <div class="modern-form-group">
                                ...
                                <div class="modern-input-wrapper">
                                    ...
                                    <select name="status" id="status"
                                        ...
                                        <option value="graduated" {{ old('status', $data->status) == 'graduated' ? 'selected' : '' }}>Graduated</option>
                                        <option value="transferred" {{ old('status', $data->status) == 'transferred' ? 'selected' : '' }}>Transferred</option>
                                    </select>
                                </div>
                                @error('status')
                                    <span class="modern-form-error">{{ $message }}</span>
                            ...
                            <div class="modern-form-group modern-form-span-2">
                                ...
                                <div class="modern-input-wrapper">
                                    ...
                                    <textarea name="notes" id="notes"
                                        ...
                                        rows="3">{{ old('notes', $data->notes) }}</textarea>
                                </div>
                                @error('notes')
                                    <span class="modern-form-error">{{ $message }}</span>
                                @enderror
...
.modern-tab:hover { color: #4361ee; }

.modern-tab.active { color: #4361ee; }
.modern-tab.active::after { background: #4361ee; }

.modern-tab i { font-size: 0.82rem; }

/* Tab Content */
.modern-tab-content { display: none; }
...
.modern-photo-file { display: none; }
...
@media (max-width: 768px) {
    ...
    .modern-form-layout { flex-direction: column; }

    .modern-form-sidebar { width: 100%; }
    ...
    if (photoInput && photoPreview) {
        photoInput.addEventListener('change', function(event) {
            ...
            if (file) {
                ...
                photoPreview.src = '{{ $data->photo ? asset("storage/" . $data->photo) : "data:image/svg+xml;base64," }}';
            }
        });
    }
