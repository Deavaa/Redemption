...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Edit Contact Message</h1>
            <p class="modern-page-subtitle">Update message from <strong>{{ $item->name }}</strong></p>
        </div>
    ...
    <div class="modern-card">
        <form method="POST" action="{{ route('admin.contact-messages.update', $item->id) }}">
            @csrf @method('PUT')
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        <h3 class="modern-form-section-title">Sender Information</h3>
                        <p class="modern-form-section-desc">Update the message sender details</p>
                    </div>
                </div>
                    ...
                    <div class="modern-form-grid">
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="name">
                                Name <span class="modern-required">*</span>
                            </label>
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="email">
                                Email <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <select name="branch_id" id="branch_id" class="modern-select {{ $errors->has('branch_id') ? 'is-invalid' : '' }}">
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        <h3 class="modern-form-section-title">Message Details</h3>
                        <p class="modern-form-section-desc">Update the subject and message content</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                        <div class="modern-form-group modern-form-span-2">
                            <label class="modern-form-label" for="subject">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text"
                                    name="subject"
                                    id="subject"
                                    class="modern-input {{ $errors->has('subject') ? 'is-invalid' : '' }}"
                        ...
                        <div class="modern-form-group modern-form-span-2">
                            ...
                            <textarea name="message"
                                id="message"
                                class="modern-textarea {{ $errors->has('message') ? 'is-invalid' : '' }}"
                                rows="5"
                                placeholder="Enter the message content..."
                                required>{{ old('message', $item->message) }}</textarea>
                            @error('message')
                                <span class="modern-form-error">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="modern-form-group modern-form-span-2">
                            <div class="modern-toggle-wrapper">
                                <label class="modern-toggle">
                                    <input type="checkbox" name="is_read" id="is_read" value="1" {{ old('is_read', $item->is_read) ? 'checked' : '' }}>
                                    <span class="modern-toggle-slider"></span>
                                </label>
                                <div class="modern-toggle-info">
                                    <span class="modern-toggle-title">Mark as Read</span>
                                    <span class="modern-toggle-desc">Set this message as already read</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modern-form-actions">
                <a href="{{ route('admin.contact-messages.index') }}" class="btn-modern btn-modern-ghost">
                    Cancel
                </a>
