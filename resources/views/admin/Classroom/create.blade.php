...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Add New Classroom</h1>
            <p class="modern-page-subtitle">Create a new class with sections and assign teachers</p>
        </div>
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Enter the class name, academic year, and capacity</p>
                    </div>
                </div>
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <select name="teacher_id" id="teacher_id" class="modern-input modern-select">
                                    ...
                                    @foreach($teachers as $t)
                                        <option value="{{ $t->id }}" {{ old('teacher_id') == $t->id ? 'selected' : '' }}>{{ $t->first_name }} {{ $t->last_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Add sections with individual capacity and homeroom teachers</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-section-info">
                        <i class="fas fa-info-circle"></i>
                        <span>Each section can have its own capacity and homeroom teacher. Add at least one section.</span>
                    </div>
                    <div id="sectionRows">
                        {{-- Default first section row --}}
...
function addSectionRow() {
    ...
    row.innerHTML =
        '<div class="modern-section-row-header">' +
            '<span class="modern-section-row-number">' + (sectionIndex + 1) + '</span>' +
            '<span class="modern-section-row-title">Section</span>' +
        '</div>' +
        '<div class="modern-section-row-body">' +
            '<div class="modern-form-grid modern-form-grid-3">' +
