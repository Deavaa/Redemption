                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-switch-wrapper">
                                <label class="modern-switch">
                                    <input type="checkbox" name="is_active" id="isActiveSwitch" value="1" {{ old('is_active', $data->is_active ?? true) ? 'checked' : '' }}>
                                    <span class="modern-switch-slider"></span>
                                </label>
                                <span class="modern-switch-label" id="statusLabel">{{ old('is_active', $data->is_active ?? true) ? 'Active' : 'Inactive' }}</span>
                            </div>
                        </div>
