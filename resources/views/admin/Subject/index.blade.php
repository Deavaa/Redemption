...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Subjects</h1>
            <p class="modern-page-subtitle">Manage subjects and curriculum</p>
        </div>
        <div class="modern-page-header-right">
            <a href="{{ route('admin.subjects.create') }}" class="btn-modern btn-modern-primary">
    ...
    <div class="modern-stats-row">
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                ...
                <span class="modern-stat-label">Total Subjects</span>
            </div>
        </div>
        <div class="modern-stat-card">
    ...
    <div class="modern-card">
        <div class="modern-card-header">
            <div class="modern-card-header-left">
                <h2 class="modern-card-title">All Subjects</h2>
                <span class="modern-badge modern-badge-light">{{ $data->total() }} records</span>
            </div>
            <div class="modern-card-header-right">
                <div class="modern-search-box">
                    <i class="fas fa-search"></i>
                    <input type="text" id="subjectSearch" placeholder="Search subjects..." onkeyup="filterTable()">
                </div>
            </div>
        </div>
                ...
                <table class="modern-table" id="subjectTable">
                    ...
                    <tbody>
                        ...
                        <tr class="modern-table-row">
                            ...
                            <td>
                                @if($item->code)
                                    <code class="modern-code-badge">{{ $item->code }}</code>
                                @else
                            ...
                            <td class="td-actions">
                                <div class="modern-action-group">
                                    <a href="{{ route('admin.subjects.edit', $item->id) }}" class="modern-btn-icon modern-btn-edit" title="Edit">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <form method="POST" action="{{ route('admin.subjects.destroy', $item->id) }}" style="display:inline" onsubmit="return confirm('Are you sure you want to delete this subject?')">
                                        @csrf @method('DELETE')
