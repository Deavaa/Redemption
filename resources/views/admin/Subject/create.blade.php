...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Add New Subject</h1>
            <p class="modern-page-subtitle">Create a new subject for the curriculum</p>
        </div>
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Enter subject name, code, and classification</p>
                    </div>
                </div>
                    ...
                    <div class="modern-form-grid">
                        ...
                        <div class="modern-form-group">
                            ...
                            @error('priority')
                                <span class="modern-form-error">{{ $message }}</span>
                            @enderror
                            <small style="color:#9ca3af;font-size:.75rem;margin-top:.25rem">Controls subject order in mark sheets, report cards, and certificates. Lower numbers appear first.</small>
                        </div>
