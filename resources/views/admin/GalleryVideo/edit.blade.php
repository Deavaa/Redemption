...
<div class="modern-page">
    ...
    <div class="modern-card">
        <form method="POST" action="{{ route('admin.gallery-videos.update', $item->id) }}" enctype="multipart/form-data">
            @csrf @method('PUT')
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        <h3 class="modern-form-section-title">Video Details</h3>
                        <p class="modern-form-section-desc">Update the video title and source URL</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                        ...
                        <div class="modern-form-group modern-form-span-2">
                            <label class="modern-form-label" for="video_url">
                                Video URL <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text"
                                    name="video_url"
                                    id="video_url"
                                    class="modern-input {{ $errors->has('video_url') ? 'is-invalid' : '' }}"
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="thumbnail">
                                Thumbnail <small>(optional - upload a new image to replace)</small>
                            </label>
                            @if($item->thumbnail)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $item->thumbnail) }}" alt="Current thumbnail" style="max-height:120px;border-radius:8px;border:1px solid #e5e7eb;">
                                </div>
                            @endif
                            <input type="file"
                                name="thumbnail"
                        ...
                        <div class="modern-form-group modern-form-span-2">
                            ...
                            <textarea name="description"
                                ...
                                rows="3"
                                placeholder="Brief description of the video...">{{ old('description', $item->description) }}</textarea>
                            @error('description')
                                <span class="modern-form-error">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="modern-form-group modern-form-span-2">
                            <div class="modern-toggle-wrapper">
                                ...
                                <div class="modern-toggle-info">
                                    ...
                                    <span class="modern-toggle-desc">Enable this video to be visible on the website gallery</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modern-form-actions">
                <a href="{{ route('admin.gallery-videos.index') }}" class="btn-modern btn-modern-ghost">
                    Cancel
                </a>
