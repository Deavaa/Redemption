...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Gallery Videos</h1>
            <p class="modern-page-subtitle">Manage video gallery for your website</p>
        </div>
        <div class="modern-page-header-right">
            <a href="{{ route('admin.gallery-videos.create') }}" class="btn-modern btn-modern-primary">
    ...
    <div class="modern-card">
        <div class="modern-card-header">
            <div class="modern-card-header-left">
                <h2 class="modern-card-title">All Videos</h2>
                <span class="modern-badge modern-badge-light">{{ $data->total() }} records</span>
            </div>
            <div class="modern-card-header-right">
                <div class="modern-search-box">
                    <i class="fas fa-search"></i>
                    <input type="text" id="videoSearch" placeholder="Search videos..." onkeyup="filterTable()">
                </div>
            </div>
        </div>
        <div class="modern-card-body">
            ...
            <div class="modern-table-wrapper">
                <table class="modern-table" id="videoTable">
                    <thead>
                        <tr>
                            ...
                            <th>Video URL</th>
                            <th>Thumbnail</th>
                            <th class="th-center">Sort Order</th>
                    ...
                    <tbody>
                        ...
                        <tr class="modern-table-row">
                            ...
                            <td>
                                ...
                                <div class="modern-cell-sub">{{ $item->description ? \Illuminate\Support\Str::limit($item->description, 50) : '' }}</div>
                            </td>
                            <td>
                                @if($item->video_url)
                                    <a href="{{ $item->video_url }}" class="modern-link" target="_blank">
                                        <i class="fas fa-external-link-alt" style="font-size:0.7rem;margin-right:3px;"></i>
                                        {{ \Illuminate\Support\Str::limit($item->video_url, 40) }}
                                    </a>
                                @else
                            ...
                            <td>
                                @if($item->thumbnail)
                                    <span class="modern-cell-text">{{ \Illuminate\Support\Str::limit($item->thumbnail, 30) }}</span>
                                @else
                                    <span class="modern-cell-muted">-</span>
                                @endif
                            </td>
                            ...
                            <td class="td-actions">
                                <div class="modern-action-group">
                                    <a href="{{ route('admin.gallery-videos.show', $item->id) }}" class="modern-btn-icon modern-btn-view" title="View">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.gallery-videos.edit', $item->id) }}" class="modern-btn-icon modern-btn-edit" title="Edit">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <form method="POST" action="{{ route('admin.gallery-videos.destroy', $item->id) }}" style="display:inline" onsubmit="return confirm('Are you sure you want to delete this video?')">
                                        @csrf @method('DELETE')
            ...
            <div class="modern-empty-state">
                ...
                <p>Get started by adding your first gallery video.</p>
                <a href="{{ route('admin.gallery-videos.create') }}" class="btn-modern btn-modern-primary">
...
.modern-link { color: #4361ee; text-decoration: none; font-weight: 500; font-size: 0.88rem; }
