...
@section('title', 'Gallery Video Details')
...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            <nav aria-label="breadcrumb" class="modern-breadcrumb">
                <ol>
                    ...
                    <li><a href="{{ route('admin.gallery-videos.index') }}">Gallery Videos</a></li>
                    <li class="active">{{ $item->title }}</li>
                </ol>
            </nav>
            <h1 class="modern-page-title">{{ $item->title }}</h1>
            <p class="modern-page-subtitle">Video details and information</p>
        </div>
        <div class="modern-page-header-right">
            ...
            <a href="{{ route('admin.gallery-videos.edit', $item->id) }}" class="btn-modern btn-modern-primary">
            ...
            <div class="modern-detail-hero">
                ...
                <div class="modern-detail-hero-info">
                    ...
                    <div class="modern-detail-hero-badges">
                        ...
                        @endif
                        <span class="modern-badge modern-badge-gold"><i class="fas fa-sort-numeric-down"></i> Order: {{ $item->sort_order ?? 0 }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="modern-detail-body">
                <div class="modern-detail-row">
                    ...
                    <div class="modern-detail-value">
                        @if($item->video_url)
                            <a href="{{ $item->video_url }}" class="modern-link" target="_blank">{{ $item->video_url }}</a>
                        @else
        ...
        <div class="modern-detail-sidebar">
            ...
            <div class="modern-card">
                ...
                <div style="padding: 1rem; text-align: center;">
                    <a href="{{ $item->video_url }}" target="_blank" class="modern-video-preview-link">
                        <div class="modern-video-preview-icon">
                            <i class="fas fa-play"></i>
                        </div>
                        <span style="font-size:0.85rem; color:#4361ee; font-weight:500;">Open Video</span>
                    </a>
                </div>
            </div>
            @endif
            ...
            <div class="modern-card">
                ...
                <div class="modern-quick-actions">
                    <a href="{{ route('admin.gallery-videos.edit', $item->id) }}" class="modern-quick-action">
                        <i class="fas fa-pen"></i>
                        <span>Edit Video</span>
                    </a>
                    @if($item->video_url)
                    <a href="{{ $item->video_url }}" target="_blank" class="modern-quick-action">
                        <i class="fas fa-external-link-alt"></i>
                        <span>Open Video Link</span>
                    </a>
                    @endif
                    <form method="POST" action="{{ route('admin.gallery-videos.destroy', $item->id) }}" onsubmit="return confirm('Are you sure you want to delete this video? This action cannot be undone.')">
                        @csrf @method('DELETE')
...
.modern-video-preview-link:hover {
    background: #f8f9ff;
}

.modern-video-preview-icon {
    width: 56px;
    height: 56px;
    border-radius: 50%;
    background: linear-gradient(135deg, #4361ee, #3a0ca3);
