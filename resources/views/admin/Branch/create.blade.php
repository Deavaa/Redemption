        ...
        <form method="POST" action="{{ route('admin.branches.store') }}">
                    ...
                    <div class="modern-form-grid">
                        <div class="modern-form-group modern-form-span-2">
                            <label class="modern-form-label" for="name">
                                Branch Name <span class="modern-required">*</span>
                            </label>
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="tel"
                                    ...
                                    value="{{ old('phone') }}"
                                    placeholder="e.g. +251 11 234 5678"
                                    required>
                            </div>
                            @error('phone')
                                <span class="modern-form-error">{{ $message }}</span>
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="email"
                                    ...
                                    value="{{ old('email') }}"
                                    placeholder="e.g. branch@redemption.edu"
                                    required>
                            </div>
                            @error('email')
                                <span class="modern-form-error">{{ $message }}</span>
                        ...
                        <div class="modern-form-group modern-form-span-2">
                            <label class="modern-form-label" for="address">
                                Address <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
            ...
            <div class="modern-form-section">
                ...
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="gps_lat">
                                GPS Latitude <small>(optional)</small>
                            </label>
                            <div class="modern-input-wrapper">
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="gps_lng">
                                GPS Longitude <small>(optional)</small>
                            </label>
                            <div class="modern-input-wrapper">
                                <i class="fas fa-crosshairs modern-input-icon"></i>
                                <input type="number"
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="principal_id">
                                Principal <small>(optional)</small>
                            </label>
                            <div class="modern-input-wrapper">
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="order">
                                Display Order <small>(optional)</small>
                            </label>
                            <div class="modern-input-wrapper">
            ...
            <div class="modern-form-actions">
                <a href="{{ route('admin.branches.index') }}" class="btn-modern btn-modern-ghost">
                    Cancel
                </a>
...
function updateMapPreview() {
    ...
    if (url) {
        // Auto-replace the field with the extracted URL so the server gets a clean URL
...
// Also handle paste events — auto-extract URL from pasted iframe code
