        ...
        <div class="modern-page-header-left">
            <nav aria-label="breadcrumb" class="modern-breadcrumb">
                <ol>
                    ...
                    <li><a href="{{ route('admin.performance-reports.index') }}">Performance Reports</a></li>
                    <li class="active">Add New</li>
                </ol>
            </nav>
            <h1 class="modern-page-title">Add Performance Report</h1>
            <p class="modern-page-subtitle">Create a new student performance evaluation</p>
        </div>
        <div class="modern-page-header-right">
            <a href="{{ route('admin.performance-reports.index') }}" class="btn-modern btn-modern-outline">
        ...
        <form method="POST" action="{{ route('admin.performance-reports.store') }}">
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        <h3 class="modern-form-section-title">Attendance</h3>
                        <p class="modern-form-section-desc">Record student attendance rate</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="attendance_percentage">
                                Attendance Percentage <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                <i class="fas fa-percentage modern-input-icon"></i>
                                <input type="number" step="0.01" min="0" max="100" name="attendance_percentage" id="attendance_percentage"
                                    class="modern-input {{ $errors->has('attendance_percentage') ? 'is-invalid' : '' }}"
                                    value="{{ old('attendance_percentage', 0) }}"
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        <h3 class="modern-form-section-title">Performance Ratings</h3>
                        <p class="modern-form-section-desc">Evaluate behavior, sports and extracurricular activities</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="behavior_rating">
                                Behavior Rating <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                <i class="fas fa-smile modern-input-icon"></i>
                                <select name="behavior_rating" id="behavior_rating" class="modern-input modern-select {{ $errors->has('behavior_rating') ? 'is-invalid' : '' }}" required>
                                    <option value="excellent" {{ old('behavior_rating') === 'excellent' ? 'selected' : '' }}>Excellent</option>
                                    <option value="good" {{ old('behavior_rating', 'good') === 'good' ? 'selected' : '' }}>Good</option>
                                    <option value="average" {{ old('behavior_rating') === 'average' ? 'selected' : '' }}>Average</option>
                                    <option value="poor" {{ old('behavior_rating') === 'poor' ? 'selected' : '' }}>Poor</option>
                                </select>
                            </div>
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="sports_rating">
                                Sports Rating <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                <i class="fas fa-running modern-input-icon"></i>
                                <select name="sports_rating" id="sports_rating" class="modern-input modern-select {{ $errors->has('sports_rating') ? 'is-invalid' : '' }}" required>
                                    <option value="excellent" {{ old('sports_rating') === 'excellent' ? 'selected' : '' }}>Excellent</option>
                                    <option value="good" {{ old('sports_rating', 'good') === 'good' ? 'selected' : '' }}>Good</option>
                                    <option value="average" {{ old('sports_rating') === 'average' ? 'selected' : '' }}>Average</option>
                                    <option value="poor" {{ old('sports_rating') === 'poor' ? 'selected' : '' }}>Poor</option>
                                </select>
                            </div>
                            @error('sports_rating')
                                <span class="modern-form-error">{{ $message }}</span>
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="extracurricular_rating">
                                Extracurricular Rating <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                <i class="fas fa-palette modern-input-icon"></i>
                                <select name="extracurricular_rating" id="extracurricular_rating" class="modern-input modern-select {{ $errors->has('extracurricular_rating') ? 'is-invalid' : '' }}" required>
                                    <option value="excellent" {{ old('extracurricular_rating') === 'excellent' ? 'selected' : '' }}>Excellent</option>
                                    <option value="good" {{ old('extracurricular_rating', 'good') === 'good' ? 'selected' : '' }}>Good</option>
                                    <option value="average" {{ old('extracurricular_rating') === 'average' ? 'selected' : '' }}>Average</option>
                                    <option value="poor" {{ old('extracurricular_rating') === 'poor' ? 'selected' : '' }}>Poor</option>
                                </select>
                            </div>
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="overall_rating">
                                Overall Rating <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                <i class="fas fa-trophy modern-input-icon"></i>
                                <select name="overall_rating" id="overall_rating" class="modern-input modern-select {{ $errors->has('overall_rating') ? 'is-invalid' : '' }}" required>
                                    <option value="excellent" {{ old('overall_rating') === 'excellent' ? 'selected' : '' }}>Excellent</option>
                                    <option value="good" {{ old('overall_rating', 'good') === 'good' ? 'selected' : '' }}>Good</option>
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        <h3 class="modern-form-section-title">Remarks</h3>
                        <p class="modern-form-section-desc">Additional notes about student performance</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                        <div class="modern-form-group modern-form-span-2">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <textarea name="remarks" id="remarks"
                                    ...
                                    placeholder="Additional observations about student performance..."
            ...
            <div class="modern-form-actions">
                <a href="{{ route('admin.performance-reports.index') }}" class="btn-modern btn-modern-ghost">
                    Cancel
                </a>
