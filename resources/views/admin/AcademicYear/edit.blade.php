...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Edit Academic Year</h1>
            <p class="modern-page-subtitle">Update academic year information for <strong>{{ $data->name }}</strong></p>
        </div>
    ...
    <div class="modern-card">
        <form method="POST" action="{{ route('admin.academic-years.update', $data->id) }}">
            @csrf @method('PUT')
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Update the year name and date range</p>
                    </div>
                </div>
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ old('start_date', $data->start_date ? $data->start_date->format('Y-m-d') : '') }}"
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ old('end_date', $data->end_date ? $data->end_date->format('Y-m-d') : '') }}"
                        ...
                        <div class="modern-form-group modern-form-span-2">
                            <div class="modern-toggle-wrapper">
                                <label class="modern-toggle">
                                    <input type="checkbox" name="is_current" id="is_current" value="1" {{ old('is_current', $data->is_current) ? 'checked' : '' }}>
