...
<div class="modern-page">
    <div class="modern-page-header">
        ...
        <div class="modern-page-header-right">
            ...
            <a href="{{ route('admin.academic-years.edit', $item->id) }}" class="btn-modern btn-modern-primary">
    ...
    <div class="modern-detail-grid">
        <div class="modern-card modern-detail-main">
            <div class="modern-detail-hero">
                ...
                <div class="modern-detail-hero-info">
                    ...
                    <div class="modern-detail-hero-badges">
                        @if($item->is_current)
                            <span class="modern-badge modern-badge-success"><i class="fas fa-check-circle"></i> Current</span>
                        @else
                            <span class="modern-badge modern-badge-warning"><i class="fas fa-clock"></i> Inactive</span>
                        @endif
            ...
            <div class="modern-detail-body">
                ...
                <div class="modern-detail-row">
                    <div class="modern-detail-label"><i class="fas fa-calendar-alt"></i> Year Name</div>
                ...
                <div class="modern-detail-row">
                    ...
                    <div class="modern-detail-value">
                        @if($item->is_current)
                            <span class="modern-badge modern-badge-success">Current Academic Year</span>
                        @else
                            <span class="modern-badge modern-badge-light">Not Current</span>
                        @endif
                    </div>
                </div>
                <div class="modern-detail-row">
                    <div class="modern-detail-label"><i class="fas fa-layer-group"></i> Terms</div>
                    <div class="modern-detail-value">{{ $item->terms->count() }} term(s)</div>
                </div>
                <div class="modern-detail-row">
                    <div class="modern-detail-label"><i class="fas fa-chalkboard"></i> Classes</div>
                    <div class="modern-detail-value">{{ $item->classes->count() }} class(es)</div>
                </div>
                <div class="modern-detail-row">
            ...
            <div class="modern-card">
                ...
                <div class="modern-quick-actions">
                    ...
                    <form method="POST" action="{{ route('admin.academic-years.destroy', $item->id) }}" onsubmit="return confirm('Are you sure you want to delete this academic year?')">
                        @csrf @method('DELETE')
                        <button type="submit" class="modern-quick-action modern-quick-action-danger"><i class="fas fa-trash-alt"></i><span>Delete</span></button>
                    </form>
                </div>
            </div>
            <div class="modern-card">
...
@push('styles')
<style>
/* Include ALL CSS for the show view - SELF-CONTAINED */
