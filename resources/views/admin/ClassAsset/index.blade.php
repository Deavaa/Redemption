        ...
        <div class="modern-page-header-left">
            <nav aria-label="breadcrumb" class="modern-breadcrumb">
                <ol>
                    ...
                    <li class="active">Class Assets</li>
                </ol>
            </nav>
            <h1 class="modern-page-title">Class Assets</h1>
            <p class="modern-page-subtitle">Manage classroom assets, equipment and inventory</p>
        </div>
        <div class="modern-page-header-right">
            <a href="{{ route('admin.class-assets.create') }}" class="btn-modern btn-modern-primary">
    ...
    <div class="modern-stats-row">
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                <span class="modern-stat-value">{{ $totalAssets }}</span>
                <span class="modern-stat-label">Total Assets</span>
            </div>
        </div>
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                <span class="modern-stat-value">{{ number_format($totalValue, 2) }}</span>
                <span class="modern-stat-label">Total Value (ETB)</span>
            </div>
        </div>
        <div class="modern-stat-card">
    ...
    <div class="modern-card">
        <div class="modern-card-header">
            <div class="modern-card-header-left">
                ...
                <span class="modern-badge modern-badge-light">{{ $data->total() }} record(s)</span>
            </div>
        ...
        <div class="modern-card-body">
                ...
                <table class="modern-table" id="assetTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="modern-cell-title">{{ $item->name }}</span>
                            </td>
                            <td>
                            ...
                            <td>
                                @if($item->section_id)
                                    <span class="modern-badge modern-badge-info">{{ $item->section->name ?? '-' }}</span>
                                @else
                                    <span class="modern-cell-muted">All Sections</span>
                                @endif
                            </td>
                            <td>
                                <span class="modern-cell-text">{{ $item->quantity }}</span>
                            </td>
                            <td class="td-center">
                                @php
                            ...
                            <td>
                                <span class="modern-cell-text">{{ $item->purchase_price ? number_format($item->purchase_price, 2) : '-' }}</span>
                            </td>
                            <td>
                                <span class="modern-cell-muted">{{ \Illuminate\Support\Str::limit($item->description ?? '-', 40) }}</span>
                            </td>
                            <td class="td-actions">
                                <div class="modern-action-group">
                                    <a href="{{ route('admin.class-assets.edit', $item->id) }}" class="modern-btn-icon modern-btn-edit" title="Edit">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <form method="POST" action="{{ route('admin.class-assets.destroy', $item->id) }}" style="display:inline" onsubmit="return confirm('Are you sure you want to delete this asset?')">
                                        @csrf @method('DELETE')
            ...
            <div class="modern-empty-state">
                ...
                <p>Start by registering your first class asset.</p>
                <a href="{{ route('admin.class-assets.create') }}" class="btn-modern btn-modern-primary">
