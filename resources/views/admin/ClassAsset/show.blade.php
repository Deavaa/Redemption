...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <p class="modern-page-subtitle">Asset details and information</p>
        </div>
        <div class="modern-page-header-right">
            ...
            <a href="{{ route('admin.class-assets.edit', $item->id) }}" class="btn-modern btn-modern-primary">
        ...
        <div class="modern-card modern-detail-main">
            ...
            <div class="modern-detail-hero">
                ...
                <div class="modern-detail-hero-info">
                    ...
                    <div class="modern-detail-hero-badges">
                        ...
                        @endphp
                        <span class="modern-badge {{ $condBadge }}"><i class="fas fa-clipboard-check"></i> {{ ucfirst($item->condition) }}</span>
                        <span class="modern-badge modern-badge-light"><i class="fas fa-hashtag"></i> Qty: {{ $item->quantity }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="modern-detail-section">
                <div class="modern-detail-section-header">
                    <i class="fas fa-box-seam"></i> Asset Information
                </div>
                <div class="modern-detail-body">
                    ...
                    <div class="modern-detail-row">
                        ...
                        <div class="modern-detail-value">{{ $item->classroom->name ?? '-' }}</div>
                    </div>
                    <div class="modern-detail-row">
                        <div class="modern-detail-label">
                        ...
                        <div class="modern-detail-value">
                            @if($item->section_id)
                                {{ $item->section->name ?? '-' }}
                            @else
                                <span class="modern-muted">All Sections</span>
                            @endif
                        </div>
                    </div>
                    <div class="modern-detail-row">
            ...
            <div class="modern-detail-section">
                ...
                <div class="modern-detail-body">
                    <div class="modern-detail-row">
                        ...
                        <div class="modern-detail-value">{{ $item->purchase_date ? \Carbon\Carbon::parse($item->purchase_date)->format('M d, Y') : '-' }}</div>
                    </div>
                    <div class="modern-detail-row">
                        <div class="modern-detail-label">
                            <i class="fas fa-coins"></i> Purchase Price
                        </div>
                        <div class="modern-detail-value">{{ $item->purchase_price ? number_format($item->purchase_price, 2) . ' ETB' : '-' }}</div>
                    </div>
                    <div class="modern-detail-row">
                        <div class="modern-detail-label">
        ...
        <div class="modern-detail-sidebar">
            ...
            <div class="modern-card">
                ...
                <div class="modern-quick-actions">
                    <a href="{{ route('admin.class-assets.edit', $item->id) }}" class="modern-quick-action">
                        <i class="fas fa-pen"></i>
                        <span>Edit Asset</span>
                    </a>
                    @if($item->classroom)
                    <a href="{{ route('admin.class-assets.index') }}" class="modern-quick-action">
                        <i class="fas fa-chalkboard"></i>
                        <span>View Classroom</span>
                    </a>
                    @endif
                    <form method="POST" action="{{ route('admin.class-assets.destroy', $item->id) }}" onsubmit="return confirm('Are you sure you want to delete this asset? This action cannot be undone.')">
                        @csrf @method('DELETE')
