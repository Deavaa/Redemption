...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Register Asset</h1>
            <p class="modern-page-subtitle">Add a new asset to a classroom inventory</p>
        </div>
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Enter the asset details and assign it to a classroom</p>
                    </div>
                </div>
                        ...
                        <div class="modern-form-group modern-form-span-2">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    value="{{ old('name') }}"
                                    placeholder="e.g. Projector, Whiteboard, Chairs" required autofocus>
                            </div>
                            @error('name')
                        ...
                        <div class="modern-form-group modern-form-span-2">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <textarea name="description" id="description"
                                    ...
                                    rows="3"
                                    placeholder="Optional description of the asset...">{{ old('description') }}</textarea>
                            </div>
                            @error('description')
                                <span class="modern-form-error">{{ $message }}</span>
                            @enderror
