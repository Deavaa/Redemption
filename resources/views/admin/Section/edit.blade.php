...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Edit Section</h1>
            <p class="modern-page-subtitle">Update section information for <strong>{{ $section->name }}</strong></p>
        </div>
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Update the section name, class, and teacher assignment</p>
                    </div>
                </div>
