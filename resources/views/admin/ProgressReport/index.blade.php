...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Progress Reports</h1>
            <p class="modern-page-subtitle">Track and manage student academic progress reports</p>
        </div>
        <div class="modern-page-header-right">
            <a href="{{ route('admin.progress-reports.create') }}" class="btn-modern btn-modern-primary">
    ...
    <div class="modern-stats-row">
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                <span class="modern-stat-value">{{ $reports->total() }}</span>
        ...
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                <span class="modern-stat-value">{{ $reports->where('status', 'published')->count() }}</span>
                <span class="modern-stat-label">Published</span>
            </div>
        </div>
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                <span class="modern-stat-value">{{ $reports->where('status', 'draft')->count() }}</span>
    ...
    <div class="modern-card">
        <div class="modern-card-header">
            <div class="modern-card-header-left">
                <h2 class="modern-card-title">All Reports</h2>
                <span class="modern-badge modern-badge-light">{{ $reports->total() }} records</span>
            </div>
        ...
        <div class="modern-card-body">
                ...
                <table class="modern-table" id="reportTable">
                    <thead>
                        <tr>
                            ...
                            <th>Term</th>
                            <th>Class</th>
                            <th class="th-center">Total Marks</th>
                            <th class="th-center">Percentage</th>
                    ...
                    <tbody>
                        ...
                        <tr class="modern-table-row">
                            ...
                            <td class="td-center">
                                <span class="modern-cell-bold">{{ $item->total_marks ?? 0 }}</span>
                            </td>
                            <td class="td-center">
                                <span class="modern-cell-bold">{{ number_format($item->total_marks / max($item->max_marks, 1) * 100, 1) }}%</span>
                            </td>
                            <td class="td-center">
                                @php
                                ...
                                @endphp
                                <span class="modern-badge {{ $gradeClass }}">{{ $grade }}</span>
                            </td>
                            <td class="td-center">
                                @if($item->class_rank)
                                    <span class="modern-cell-bold">{{ $item->class_rank }}</span>
                                @else
                            ...
                            <td class="td-center">
                                @if($item->status === 'published')
                                    <span class="modern-badge modern-badge-success">Published</span>
                                @elseif($item->status === 'archived')
                                    <span class="modern-badge modern-badge-light">Archived</span>
                                @else
                            ...
                            <td class="td-actions">
                                <div class="modern-action-group">
                                    <a href="{{ route('admin.progress-reports.edit', $item->id) }}" class="modern-btn-icon modern-btn-edit" title="Edit">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <form method="POST" action="{{ route('admin.progress-reports.destroy', $item->id) }}" style="display:inline" onsubmit="return confirm('Are you sure you want to delete this report?')">
                                        @csrf @method('DELETE')
            ...
            <div class="modern-empty-state">
                ...
                <p>Get started by creating the first student progress report.</p>
                <a href="{{ route('admin.progress-reports.create') }}" class="btn-modern btn-modern-primary">
