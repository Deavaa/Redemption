...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Progress Report</h1>
            <p class="modern-page-subtitle">Detailed view of student academic progress</p>
        </div>
    ...
    <div class="modern-detail-grid">
        ...
        <div class="modern-card modern-detail-main">
            ...
            <div class="modern-detail-body">
                ...
                <div class="modern-detail-section-label">Academic Information</div>
                ...
                <div class="modern-detail-section-label">Performance</div>
        ...
        <div class="modern-detail-sidebar">
            ...
            <div class="modern-card">
                ...
                <div class="modern-quick-actions">
                    ...
                    <a href="{{ route('admin.progress-reports.index') }}" class="modern-quick-action">
...
.modern-detail-value-bold { font-weight: 700; }
...
/* Performance Summary */
.modern-summary-content { padding: 0.85rem 1.25rem; }
...
.modern-summary-item + .modern-summary-item { border-top: 1px solid #f3f4f6; }

.modern-summary-label { color: #9ca3af; font-size: 0.82rem; }
.modern-summary-value { color: #1a1a2e; font-size: 0.82rem; font-weight: 600; }

.modern-progress-wrapper { padding-top: 0.75rem; }
