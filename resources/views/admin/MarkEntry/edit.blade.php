...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Edit Mark Entry</h1>
            <p class="modern-page-subtitle">Update marks and assessment scores for <strong>Entry #{{ $item->id }}</strong></p>
        </div>
    ...
    <div class="modern-card">
        <form method="POST" action="{{ route('admin.mark-entries.update', $item->id) }}">
            @csrf @method('PUT')
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        <h3 class="modern-form-section-title">Student & Exam Details</h3>
                        <p class="modern-form-section-desc">Update the student, exam, and subject information</p>
                    </div>
                </div>
                    ...
                    <div class="modern-form-grid">
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="exam_id">
                                Exam ID <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text"
                                    name="exam_id"
                                    id="exam_id"
                                    class="modern-input {{ $errors->has('exam_id') ? 'is-invalid' : '' }}"
                                    value="{{ old('exam_id', $item->exam_id) }}"
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="subject_id">
                                Subject ID <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text"
                                    name="subject_id"
                                    id="subject_id"
                                    class="modern-input {{ $errors->has('subject_id') ? 'is-invalid' : '' }}"
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="marks_obtained">
                                Marks Obtained <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                ...
                                <input type="number"
                                    name="marks_obtained"
                                    id="marks_obtained"
                                    class="modern-input {{ $errors->has('marks_obtained') ? 'is-invalid' : '' }}"
                                    value="{{ old('marks_obtained', $item->marks_obtained) }}"
                                    placeholder="e.g. 85"
                                    step="any"
                                    required>
                            </div>
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Update maximum marks and grading information</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="max_marks">
                                Max Marks <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                ...
                                <input type="number"
                                    name="max_marks"
                                    id="max_marks"
                                    class="modern-input {{ $errors->has('max_marks') ? 'is-invalid' : '' }}"
                                    value="{{ old('max_marks', $item->max_marks) }}"
                                    placeholder="e.g. 100"
                                    step="any"
                                    required>
                            </div>
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="grade">
                                Grade <small>(optional)</small>
                            </label>
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text"
                                    name="grade"
                                    id="grade"
                                    class="modern-input {{ $errors->has('grade') ? 'is-invalid' : '' }}"
                        ...
                        <div class="modern-form-group modern-form-span-2">
                            ...
                            <div class="modern-input-wrapper">
                                <i class="fas fa-comment-dots modern-input-icon"></i>
                                <textarea
                                    name="remarks"
                                    id="remarks"
                                    class="modern-input modern-textarea {{ $errors->has('remarks') ? 'is-invalid' : '' }}"
                                    placeholder="Add any remarks or comments about this mark entry"
            ...
            <div class="modern-form-actions">
                <a href="{{ route('admin.mark-entries.index') }}" class="btn-modern btn-modern-ghost">
                    Cancel
                </a>
