...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">New Mark Entry</h1>
            <p class="modern-page-subtitle">Record student assessment scores and marks</p>
        </div>
    ...
    <div class="modern-card">
        <form method="POST" action="{{ route('admin.mark-entries.store') }}">
            @csrf
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Select the student, exam, and subject for this mark entry</p>
                    </div>
                </div>
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Enter maximum marks and additional grading information</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
