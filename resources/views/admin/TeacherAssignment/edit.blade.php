...
<div class="modern-page">
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Edit Teacher Assignment</h1>
            <p class="modern-page-subtitle">Update assignment details for this teacher</p>
        </div>
    ...
    <form method="POST" action="{{ route('admin.teacher-assignments.update', $item->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="modern-form-section">
            <div class="modern-form-section-header">
                ...
                <div>
                    ...
                    <p class="modern-form-section-desc">Update the teacher, class, section, subject and academic year</p>
                </div>
            </div>
                ...
                <div class="modern-form-grid">
                    <div class="modern-form-group">
                        ...
                        <div class="modern-input-wrapper">
                            ...
                            <input type="text" name="teacher_id" class="modern-input" value="{{ old('teacher_id', $item->teacher_id ?? '') }}" placeholder="Enter teacher ID" required>
                        </div>
                        @error('teacher_id')
                    ...
                    <div class="modern-form-group">
                        ...
                        <div class="modern-input-wrapper">
                            ...
                            <input type="text" name="class_id" class="modern-input" value="{{ old('class_id', $item->class_id ?? '') }}" placeholder="Enter class ID" required>
                        </div>
                        @error('class_id')
                            <div class="modern-form-error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="modern-form-group">
                        ...
                        <div class="modern-input-wrapper">
                            ...
                            <input type="text" name="section_id" class="modern-input" value="{{ old('section_id', $item->section_id ?? '') }}" placeholder="Enter section ID" required>
                        </div>
                        @error('section_id')
                            <div class="modern-form-error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="modern-form-group">
                        ...
                        <div class="modern-input-wrapper">
                            ...
                            <input type="text" name="subject_id" class="modern-input" value="{{ old('subject_id', $item->subject_id ?? '') }}" placeholder="Enter subject ID" required>
                        </div>
                        @error('subject_id')
                            <div class="modern-form-error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="modern-form-group modern-form-span-2">
                        ...
                        <div class="modern-input-wrapper">
                            ...
                            <input type="text" name="academic_year_id" class="modern-input" value="{{ old('academic_year_id', $item->academic_year_id ?? '') }}" placeholder="Enter academic year ID" required>
                        </div>
