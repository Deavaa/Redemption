...
@push('styles')
    ...
    <style>
        ...
        /* Upload status inside Summernote */
        .note-upload-status {
            display: inline-flex;
            align-items: center;
            gap: 8px;
        ...
        if (coverZone) {
            ...
            coverZone.addEventListener('drop', function(e) {
                if (e.dataTransfer.files && e.dataTransfer.files[0]) {
                    ...
                    // Assign to input so the form submits it
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.news.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="title" class="form-control form-control-lg" value="{{ old('title') }}" placeholder="Enter a catchy news title..." required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="cover-upload-zone" id="coverUploadZone">
                        ...
                        <p class="cover-upload-title">Click to upload or drag & drop</p>
                        <p class="cover-upload-hint">PNG, JPG, GIF, WEBP — auto-compressed to ~2MB (up to 50MB accepted)</p>
                        <input type="file" name="image" id="coverImageInput" accept="image/*" data-compress="1920" data-maxsize="1500">
                    </div>
                ...
                <div class="d-flex justify-content-end gap-2 border-top pt-3">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg"><i class="fas fa-save me-1"></i> Save News</button>
                </div>
            </form>
        </div>
    </div>
