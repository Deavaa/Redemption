...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">Edit ID Card</h1>
            <p class="modern-page-subtitle">Update identification card for <strong>{{ $item->card_number ?? $item->student_id }}</strong></p>
        </div>
    ...
    <div class="modern-card">
        <form method="POST" action="{{ route('admin.id-cards.update', $item->id) }}">
            @csrf @method('PUT')
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        <h3 class="modern-form-section-title">Card Information</h3>
                        <p class="modern-form-section-desc">Update the card holder and identification details</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="card_number">
                                Card Number <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text"
                                    name="card_number"
                                    id="card_number"
                                    class="modern-input {{ $errors->has('card_number') ? 'is-invalid' : '' }}"
                                    value="{{ old('card_number', $item->card_number) }}"
                                    placeholder="e.g. ID-2025-0001"
                                    required>
                            </div>
                            @error('card_number')
                                <span class="modern-form-error">{{ $message }}</span>
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        <h3 class="modern-form-section-title">Type & Validity</h3>
                        <p class="modern-form-section-desc">Update the card type and validity period</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="type">
                                Card Type <span class="modern-required">*</span>
                            </label>
                            <div class="modern-input-wrapper">
                                <i class="fas fa-tag modern-input-icon"></i>
                                <select name="type"
                                    id="type"
                                    class="modern-select {{ $errors->has('type') ? 'is-invalid' : '' }}"
                                    required>
                                    <option value="">Select type...</option>
                                    <option value="student" {{ old('type', $item->type) === 'student' ? 'selected' : '' }}>Student</option>
                                    <option value="staff" {{ old('type', $item->type) === 'staff' ? 'selected' : '' }}>Staff</option>
                                </select>
                            </div>
                            @error('type')
                                <span class="modern-form-error">{{ $message }}</span>
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <select name="status"
                                    id="status"
                                    class="modern-select {{ $errors->has('status') ? 'is-invalid' : '' }}"
                                    required>
                        ...
                        <div class="modern-form-group">
                            <label class="modern-form-label" for="expiry_date">
                                Expiry Date
                            </label>
                            <div class="modern-input-wrapper">
                                ...
                                <input type="date"
                                    name="expiry_date"
                                    id="expiry_date"
                                    class="modern-input {{ $errors->has('expiry_date') ? 'is-invalid' : '' }}"
                                    value="{{ old('expiry_date', isset($item->expiry_date) && $item->expiry_date ? ($item->expiry_date instanceof \DateTime ? $item->expiry_date->format('Y-m-d') : $item->expiry_date) : '') }}">
                            </div>
                            @error('expiry_date')
                                <span class="modern-form-error">{{ $message }}</span>
                            @enderror
            ...
            <div class="modern-form-actions">
                <a href="{{ route('admin.id-cards.index') }}" class="btn-modern btn-modern-ghost">
                    Cancel
                </a>
