...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        ...
        <div class="modern-page-header-right">
            ...
            <a href="{{ route('admin.id-cards.edit', $item->id) }}" class="btn-modern btn-modern-primary">
        ...
        <div class="modern-card modern-detail-main">
            <div class="modern-detail-hero">
                ...
                <div class="modern-detail-hero-info">
                    <h2 class="modern-detail-hero-title">{{ $item->card_number ?? '—' }}</h2>
            ...
            <div class="modern-detail-body">
                <div class="modern-detail-row">
                    ...
                    <div class="modern-detail-value">{{ $item->student_id ?? '-' }}</div>
                </div>
                <div class="modern-detail-row">
                    <div class="modern-detail-label">
                        <i class="fas fa-hashtag"></i> Card Number
                    </div>
                    <div class="modern-detail-value">{{ $item->card_number ?? '-' }}</div>
                </div>
                <div class="modern-detail-row">
                    <div class="modern-detail-label">
                ...
                <div class="modern-detail-row">
                    ...
                    <div class="modern-detail-value">
                        {{ $item->issue_date ? $item->issue_date->format('M d, Y') : '-' }}
                    </div>
                </div>
                <div class="modern-detail-row">
                    <div class="modern-detail-label">
                    ...
                    <div class="modern-detail-value">
                        @if(isset($item->expiry_date) && $item->expiry_date)
                            {{ $item->expiry_date instanceof \DateTime ? $item->expiry_date->format('M d, Y') : $item->expiry_date }}
                        @else
        ...
        <div class="modern-detail-sidebar">
            ...
            <div class="modern-card">
                ...
                <div class="modern-quick-actions">
                    <a href="{{ route('admin.id-cards.edit', $item->id) }}" class="modern-quick-action">
                        <i class="fas fa-pen"></i>
                        <span>Edit ID Card</span>
                    </a>
                    <form method="POST" action="{{ route('admin.id-cards.destroy', $item->id) }}" onsubmit="return confirm('Are you sure you want to delete this ID card? This action cannot be undone.')">
                        @csrf @method('DELETE')
                        <button type="submit" class="modern-quick-action modern-quick-action-danger">
                            <i class="fas fa-trash-alt"></i>
                            <span>Delete ID Card</span>
                        </button>
                    </form>
                </div>
            </div>
