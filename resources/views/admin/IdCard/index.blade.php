...
<div class="modern-page">
    ...
    <div class="modern-page-header">
        <div class="modern-page-header-left">
            ...
            <h1 class="modern-page-title">ID Cards</h1>
            <p class="modern-page-subtitle">Manage student and staff identification cards</p>
        </div>
        <div class="modern-page-header-right">
            <a href="{{ route('admin.id-cards.create') }}" class="btn-modern btn-modern-primary">
    ...
    <div class="modern-stats-row">
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                ...
                <span class="modern-stat-label">Total Cards</span>
            </div>
        </div>
        <div class="modern-stat-card">
        ...
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-info">
                <span class="modern-stat-value">{{ $data->where('status', 'expired')->count() }}</span>
                <span class="modern-stat-label">Expired</span>
            </div>
        </div>
    </div>
    ...
    <div class="modern-card">
        <div class="modern-card-header">
            <div class="modern-card-header-left">
                <h2 class="modern-card-title">All ID Cards</h2>
                <span class="modern-badge modern-badge-light">{{ $data->total() }} records</span>
            </div>
            <div class="modern-card-header-right">
                <div class="modern-search-box">
                    <i class="fas fa-search"></i>
                    <input type="text" id="idCardSearch" placeholder="Search ID cards..." onkeyup="filterTable()">
                </div>
            </div>
        </div>
        <div class="modern-card-body">
            ...
            <div class="modern-table-wrapper">
                <table class="modern-table" id="idCardTable">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr class="modern-table-row">
                            ...
                            <td>
                                <div class="modern-cell-text">{{ $item->card_number ?? '—' }}</div>
                            </td>
                            <td class="td-center">
                                @if(isset($item->type) && $item->type === 'staff')
                                    <span class="modern-badge modern-badge-gold"><i class="fas fa-user-tie"></i> Staff</span>
                                @else
                                    <span class="modern-badge modern-badge-info"><i class="fas fa-user-graduate"></i> Student</span>
                                @endif
                            </td>
                            <td>
                                <div class="modern-cell-text">{{ $item->issue_date ? $item->issue_date->format('M d, Y') : '—' }}</div>
                            </td>
                            <td class="td-center">
                                @if($item->status === 'active')
                                    <span class="modern-badge modern-badge-success"><i class="fas fa-check-circle"></i> Active</span>
                                @elseif($item->status === 'expired')
                                    <span class="modern-badge modern-badge-danger"><i class="fas fa-times-circle"></i> Expired</span>
                                @else
                            ...
                            <td class="td-actions">
                                <div class="modern-action-group">
                                    <a href="{{ route('admin.id-cards.show', $item->id) }}" class="modern-btn-icon modern-btn-view" title="View">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.id-cards.edit', $item->id) }}" class="modern-btn-icon modern-btn-edit" title="Edit">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <form method="POST" action="{{ route('admin.id-cards.destroy', $item->id) }}" style="display:inline" onsubmit="return confirm('Are you sure you want to delete this ID card?')">
                                        @csrf @method('DELETE')
            ...
            <div class="modern-empty-state">
                ...
                <p>Get started by adding your first ID card.</p>
                <a href="{{ route('admin.id-cards.create') }}" class="btn-modern btn-modern-primary">
...
function filterTable() {
    ...
    const table = document.getElementById('idCardTable');
