...
<div class="modern-page">
    ...
    <div class="modern-card">
        <form method="POST" action="{{ route('admin.staff.update', ['staff' => $user->id]) }}">@csrf @method('PUT')
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Update the staff member's personal details</p>
                    </div>
                </div>
                    ...
                    <div class="modern-form-grid">
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text" name="qualification" id="qualification" class="modern-input {{ $errors->has('qualification') ? 'is-invalid' : '' }}" value="{{ old('qualification', $user->qualification ?? '') }}" placeholder="BA, BSc, MA, PhD">
                            </div>
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        ...
                        <p class="modern-form-section-desc">Update the user's role and branch if applicable</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
            ...
            {{-- Account Status & Security Section --}}
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        <h3 class="modern-form-section-title">Account Status & Security</h3>
                        <p class="modern-form-section-desc">Manage account activation and change password</p>
                    </div>
                </div>
                <div class="modern-form-section-body">
                    <div class="modern-form-grid">
                        <div class="modern-form-group">
                            ...
                            <div class="modern-switch-wrapper">
                                <label class="modern-switch">
                                    <input type="checkbox" name="is_active" id="isActiveSwitch" value="1" {{ old('is_active', $user->is_active) ? 'checked' : '' }}>
                                    <span class="modern-switch-slider"></span>
                                </label>
                                <span class="modern-switch-label" id="statusLabel">{{ old('is_active', $user->is_active) ? 'Active' : 'Inactive' }}</span>
                            </div>
                        </div>
                    ...
                    <div class="modern-form-grid">
                        <div class="modern-form-group modern-form-span-2">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <textarea name="address" id="address" class="modern-input modern-textarea {{ $errors->has('address') ? 'is-invalid' : '' }}" rows="3" placeholder="e.g. Bole, Addis Ababa">{{ old('address', $user->address ?? '') }}</textarea>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Status switch label
    var statusSwitch = document.getElementById('isActiveSwitch');
    var statusLabel = document.getElementById('statusLabel');
    function updateStatusLabel() {
        statusLabel.textContent = statusSwitch.checked ? 'Active' : 'Inactive';
        statusLabel.style.color = statusSwitch.checked ? '#059669' : '#dc2626';
    }
