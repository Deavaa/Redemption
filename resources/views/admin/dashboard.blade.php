        ...
        <div class="modern-dashboard-grid">
                        ...
                        <table class="modern-table">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="modern-table-module">
                                            <div class="modern-table-module-icon modern-stat-icon-blue"><i
                                    ...
                                    <td><a href="{{ route('admin.branches.index') }}" class="btn-modern btn-modern-ghost"
                                            style="padding:0.35rem 0.75rem;font-size:0.8rem;">Manage</a></td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="modern-table-module">
                                            <div class="modern-table-module-icon modern-stat-icon-green"><i
                                    ...
                                    <td><a href="{{ route('admin.teachers.index') }}" class="btn-modern btn-modern-ghost"
                                            style="padding:0.35rem 0.75rem;font-size:0.8rem;">Manage</a></td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="modern-table-module">
                                            <div class="modern-table-module-icon modern-stat-icon-gold"><i
                                    ...
                                    <td><a href="{{ route('admin.students.index') }}" class="btn-modern btn-modern-ghost"
                                            style="padding:0.35rem 0.75rem;font-size:0.8rem;">Manage</a></td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="modern-table-module">
                                            <div class="modern-table-module-icon modern-stat-icon-purple"><i
                                    ...
                                    <td><a href="{{ route('admin.classrooms.index') }}"
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin.subjects.index') }}" class="btn-modern btn-modern-ghost"
                                            style="padding:0.35rem 0.75rem;font-size:0.8rem;">Manage</a></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td><a href="{{ route('admin.academic-years.index') }}"
                                            class="btn-modern btn-modern-ghost"
                                            style="padding:0.35rem 0.75rem;font-size:0.8rem;">Manage</a></td>
                                </tr>
                            </tbody>
            ...
            <div class="modern-dashboard-sidebar">
                ...
                @if ($currentYear)
                    <div class="modern-card" style="margin-bottom: 1.25rem;">
                        <div class="modern-card-header"
                            style="background: linear-gradient(135deg, #10b981, #059669); border-radius: 14px 14px 0 0;">
                            <div class="modern-card-header-left">
                                <i class="fas fa-calendar-check" style="color:#fff;font-size:1.1rem;"></i>
                                <h3 class="modern-card-title" style="color:#fff;">Current Academic Year</h3>
                            </div>
...
=======
                        <div class="modern-card-body" style="text-align:center;padding:1.5rem;">
                            <h4 style="color:#10b981;font-weight:800;margin:0 0 0.35rem;font-size:1.35rem;">
                                {{ $currentYear->name }}</h4>
                            @if ($currentYear->start_date)
                                <p style="color:#6c757d;margin:0 0 0.75rem;font-size:0.85rem;">
                                    {{ $currentYear->start_date }} &mdash; {{ $currentYear->end_date }}</p>
                            @endif
                                ...
                                @foreach ($recentPayments as $payment)
                                    <div class="modern-activity-item">
                                        ...
                                        <div class="modern-activity-info">
                                            <span
                                                class="modern-activity-title">{{ $payment->student->first_name ?? 'Unknown' }}
                                                {{ $payment->student->last_name ?? '' }}</span>
                                            <span
                                                class="modern-activity-desc">{{ $payment->payment_date?->format('M d, Y') ?? '-' }}
                                                &middot; {{ $payment->payment_method ?? '-' }}</span>
                                        </div>
                                        <span
                                            class="modern-activity-amount">{{ number_format($payment->amount_paid, 2) }}</span>
                                    </div>
                                @endforeach
                            </div>
                        @else
...
>>>>>>> Stashed changes
            ...
            .modern-stat-icon-gold {
                background: #fefce8;
                color: #d97706;
            }

            .modern-stat-icon-purple {
                background: #f5f3ff;
                color: #7c3aed;
            }
...
>>>>>>> Stashed changes
            ...
            .modern-form-section-icon-blue {
                background: #eef2ff;
                color: #4361ee;
            }

            .modern-form-section-icon-green {
                background: #ecfdf5;
                color: #10b981;
            }

            .modern-form-section-icon-gold {
                background: #fefce8;
                color: #d97706;
            }

            .modern-form-section-icon-purple {
                background: #f5f3ff;
                color: #7c3aed;
            }
...
=======
            ...
            @media (max-width: 768px) {
                ...
                .modern-page-header-right .btn-modern {
                    flex: 1;
                    justify-content: center;
                }
            }
