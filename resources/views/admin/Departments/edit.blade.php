        ...
        <form method="POST" action="{{ route('admin.departments.update', $department->id) }}">
            ...
            <div class="modern-form-section">
                <div class="modern-form-section-header">
                    ...
                    <div>
                        <h3 class="modern-form-section-title">Edit Department</h3>
                        <p class="modern-form-section-desc">Update department information</p>
                    </div>
                </div>
                    ...
                    <div class="modern-form-grid">
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text" name="name" class="modern-input" value="{{ old('name', $department->name) }}" required>
                            </div>
                        ...
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <input type="text" name="code" class="modern-input" value="{{ old('code', $department->code) }}" placeholder="e.g. SCI, MATH, HUM">
                            </div>
                        </div>
                        <div class="modern-form-group">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <select name="type" class="modern-input modern-select" required>
                                    ...
                                    <option value="administrative" {{ old('type', $department->type) == 'administrative' ? 'selected' : '' }}>Administrative</option>
                                    <option value="support" {{ old('type', $department->type) == 'support' ? 'selected' : '' }}>Support Staff</option>
                                </select>
                            </div>
                        </div>
                        <div class="modern-form-group">
                        ...
                        <div class="modern-form-group modern-form-span-2">
                            ...
                            <div class="modern-input-wrapper">
                                ...
                                <textarea name="description" class="modern-input modern-textarea" rows="3">{{ old('description', $department->description) }}</textarea>
                            </div>
                        </div>
                        <div class="modern-form-group">
                            <label class="modern-form-label">Active</label>
                            <div style="display:flex;align-items:center;gap:.5rem;padding-top:.35rem;">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $department->is_active) ? 'checked' : '' }} style="width:18px;height:18px;accent-color:#4361ee;">
            ...
            <div class="modern-form-actions">
                ...
                <button type="submit" class="btn-modern btn-modern-primary"><i class="fas fa-check"></i> Update Department</button>
            </div>
        </form>
    </div>
</div>
