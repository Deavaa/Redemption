<?php
echo "=== Fix Classroom view ===\n";
 $b = __DIR__;

 $v = '@extends("layouts.admin")
...
file_put_contents($b . '/resources/views/admin/Classroom/index.blade.php', $v);
echo "[OK] Classroom/index.blade.php written\n";
