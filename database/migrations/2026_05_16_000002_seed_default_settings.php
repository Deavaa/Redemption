...
return new class extends Migration
{
    ...
    {
        // Only delete the specific settings we created
        Setting::whereIn('key', [
            'school_name', 'school_tagline', 'school_description', 'school_logo',
            'school_phone', 'school_email', 'school_address', 'school_website',
            'total_students', 'total_teachers', 'university_acceptance', 'years_of_excellence',
            'facebook_url', 'twitter_url', 'youtube_url', 'telegram_url', 'instagram_url', 'linkedin_url',
            'about_description', 'about_mission', 'about_vision',
            'cta_title', 'cta_description', 'cta_button_text', 'cta_button_url', 'footer_text',
            'mail_host', 'mail_port', 'mail_username', 'mail_from_address', 'mail_from_name',
            'fee_due_day', 'fee_late_penalty', 'fee_currency',
            'primary_color', 'secondary_color', 'show_slider', 'show_stats', 'show_team', 'show_gallery',
        ])->delete();
    }
};
