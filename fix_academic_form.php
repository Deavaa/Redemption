<?php
echo "Creating improved Academic Year forms...\n";
 $dir = 'resources/views/admin/AcademicYear';
@mkdir($dir,0755,true);
...
echo "DONE: Academic Year forms updated with correct Ethiopian conversion\n";
